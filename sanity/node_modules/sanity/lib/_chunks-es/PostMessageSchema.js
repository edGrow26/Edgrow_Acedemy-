...
import { useWorkspace, VARIANTS_STUDIO_CLIENT_OPTIONS, RELEASES_STUDIO_CLIENT_OPTIONS, isReleasePerspective, useClient, getPublishedId } from "sanity";
...
function PostMessageSchema(props) {
  ...
  let t2;
  $[4] !== perspective || $[5] !== variant ? (t2 = variant ? VARIANTS_STUDIO_CLIENT_OPTIONS : isReleasePerspective(perspective) ? RELEASES_STUDIO_CLIENT_OPTIONS : {
    apiVersion: API_VERSION
  }, $[4] = perspective, $[5] = variant, $[6] = t2) : t2 = $[6];
  ...
  }), t4 = [comlink, client, perspective, variant], $[7] = client, $[8] = comlink, $[9] = perspective, $[10] = variant, $[11] = t3, $[12] = t4) : (t3 = $[11], t4 = $[12]), useEffect(t3, t4), null;
}
function _temp3(t0) {
  const {
    path: path_1,
