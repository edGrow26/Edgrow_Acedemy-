...
import { isPublishedId, isDraftId, getReleaseIdFromReleaseDocumentId, getVersionFromId, useTranslation, useDocumentVersions, useActiveReleases, getPublishedId, useEditState, useWorkspace, isReleaseDocument, getReleaseTone, isReleaseScheduledOrScheduling, ReleaseAvatar, isSystemBundleName, PUBLISHED, LATEST, useFormatRelativeLocalePublishDate, getDraftId, getVersionId, ReleaseTitle, useMiddlewareComponents, ChangeIndicatorsTracker, VirtualizerScrollInstanceProvider, useDocumentForm, LoadingBlock, FormBuilder, isVersionId, createPatchChannel, getDocumentVariantType, LegacyLayerProvider, IsLastPaneProvider, useGetI18nText, useI18nText, TooltipOfDisabled, ContextMenuButton, StatusButton, isDev, CommentsEnabledProvider, useCommentsEnabled, usePerspective, getTargetScopeId, COMMENTS_INSPECTOR_NAME, CommentsProvider, GetHookCollectionState, EMPTY_ARRAY as EMPTY_ARRAY$2, getDocumentIdForCanvasLink, useCanvasCompanionDoc, useUnique, isPublishedPerspective, prepareForPreview, useValuePreview, useDocumentOperationEvent, useDocumentLimitsUpsellContext, isDocumentLimitError, Translate, isNewDocument, Resizable, useKeyValueStore, isRecord, isString, isDraftPerspective, useDocumentOperation, isDeprecatedSchemaType, useProjectId, useClient, useZIndex, useCurrentUser, useListFormat, useDocumentPreviewStore, isSystemBundle, useScheduledDraftDocument, useArchivedReleases, isCardinalityOneRelease, getVersionInlineBadge, useNavigateToCanvasDoc, isPerspectiveWriteable, ReleasesNav, useVersionOperations, useConditionalToast, isAgentBundleName, useVariantDocumentOperations, useGetDefaultPerspective, getVariantTitle, useOnlyHasVersions, useSetPerspective, VersionInlineBadge, isGoingToUnpublish, useDocumentStore, useDocumentPresence, FormRow, FormContainer, PresenceOverlay, fromMutationPatches, useDocumentPreviewValues, useManageFavorite, useActiveWorkspace, CapabilityGate, useFilteredReleases, usePausedScheduledDraft, isPausedCardinalityOneRelease, ScrollContainer, getPairTarget, useTargetDocumentState, useStudioUrl, ReleaseAvatarIcon, useSingleDocRelease, useSchema, useAllVariants, useAgentVersionDisplay, useSetVariant, getTargetDocument, VersionChip, Chip, useDateTimeFormat, useFieldActions, FieldPresenceInner, useDocumentVersionInfo, getPreviewStateObservable, DocumentPreviewPresence, DocumentStatusIndicator, DocumentStatus, getPreviewValueWithFallback, SanityDefaultPreview, PreviewCard, DEFAULT_STUDIO_CLIENT_OPTIONS, useDocumentVersionTypeSortedList, useDocumentPairPermissions, InsufficientPermissionsMessage, useValidationStatus, useSyncState, useRelativeTime, useSource, Hotkeys, isSanityDefinedAction, DocumentGroupInventoryAction, DocumentGroupInventory, UserAvatar, useUser, AvatarSkeleton, CommandList, TextWithTone, useTimelineSelector, useEvents, TIMELINE_ITEM_I18N_KEY_MAPPING as TIMELINE_ITEM_I18N_KEY_MAPPING$1, useGlobalCopyPasteElementHandler, useDocumentIdStack, FieldActionsResolver, GetFormValueProvider, FieldActionsProvider, ChangeConnectorRoot, useTemplates, useInitialValue, useCopyPaste, DivergencesProvider, selectUpstreamVersion, pathToString, ParseErrorsProvider, useDocumentDivergences, useEventsStore, PerspectiveProvider, EventsProvider, useTimelineStore, SingleDocReleaseProvider, CopyPasteProvider, SourceProvider, useDocumentType, useTemplatePermissions, ReferenceInputOptionsProvider, EMPTY_OBJECT, CrossDatasetReferencePreview, getPreviewPaths, isNonNullable as isNonNullable$1, getReferencePaths, ErrorActions, collate, getSearchableTypes, compileFieldPath, createSearch, createSWR, useSearchMaxFieldDepth, measureFirstMatch, catchWithCount, useReconnectingToast, ChangeFieldWrapper, NoChanges, ChangeList, isDeleteDocumentVersionEvent, isDeleteDocumentGroupEvent, isUnpublishDocumentEvent, isScheduleDocumentVersionEvent, isUnscheduleDocumentVersionEvent, Event, RELEASES_INTENT, isCreateDocumentVersionEvent, isEditDocumentVersionEvent, isPublishDocumentVersionEvent, ChangesError, isArray, useParseErrors, mergeParseErrors, isValidationError, isValidationWarning, definePlugin } from "sanity";
...
import { Subject, distinctUntilChanged, filter, map, of, merge, startWith, catchError, concat, from, combineLatest, tap as tap$1, fromEvent, EMPTY, timer, firstValueFrom, timeout, BehaviorSubject, switchMap as switchMap$1, defer, mergeMap, throwError, share, partition, throttleTime, asyncScheduler, NEVER, debounce } from "rxjs";
...
function useDiffViewState(t0) {
  ...
  const mode = t2, anyParamSet = [previousDocument, nextDocument, mode].some(_temp$O), previousState = useRef(void 0), t3 = previousDocument ?? "", t4 = nextDocument ?? "", t5 = mode ?? "";
  let t6;
...
const VersionModeHeaderLayout = /* @__PURE__ */ styled.header.withConfig({
  displayName: "VersionModeHeaderLayout",
  componentId: "sc-w17umd-0"
})(["display:grid;grid-area:header;grid-template-columns:1fr min-content 1fr;border-block-end:1px solid var(--card-border-color);"]), VersionModeHeaderLayoutSection = /* @__PURE__ */ styled.div.withConfig({
...
const DialogLayout = /* @__PURE__ */ styled.div.withConfig({
...
const Scroller$5 = /* @__PURE__ */ styled.div.withConfig({
  displayName: "Scroller",
  componentId: "sc-16z7cpf-0"
})(["position:relative;height:100%;overflow:auto;scroll-behavior:smooth;scrollbar-width:var(--scrollbar-width);overscroll-behavior:contain;will-change:scroll-position;"]), DiffViewPaneLayout = /* @__PURE__ */ styled(Card).withConfig({
  displayName: "DiffViewPaneLayout",
  componentId: "sc-1856b20-0"
})(["position:relative;grid-area:var(--grid-area);"]), Container = /* @__PURE__ */ styled(Container$1).withConfig({
  ...
  const t10 = t9;
  let t11;
  $[14] !== DocumentLayout2 || $[15] !== documentId || $[16] !== documentType ? (t11 = /* @__PURE__ */ jsx(DialogProvider, { position: "absolute", children: /* @__PURE__ */ jsx(Container, { ref: containerElement, padding: 4, width: 1, children: /* @__PURE__ */ jsx(DocumentLayout2, { documentId, documentType }) }) }), $[14] = DocumentLayout2, $[15] = documentId, $[16] = documentType, $[17] = t11) : t11 = $[17];
  let t12;
  $[18] !== portalElement || $[19] !== t11 ? (t12 = /* @__PURE__ */ jsx(PortalProvider, { element: portalElement, children: t11 }), $[18] = portalElement, $[19] = t11, $[20] = t12) : t12 = $[20];
  let t13;
  $[21] !== ref || $[22] !== t10 || $[23] !== t12 ? (t13 = /* @__PURE__ */ jsx(Scroller$5, { ref, style: t10, children: t12 }), $[21] = ref, $[22] = t10, $[23] = t12, $[24] = t13) : t13 = $[24];
  let t14;
  $[25] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t14 = /* @__PURE__ */ jsx("div", { "data-testid": "diffView-document-panel-portal", ref: setPortalElement }), $[25] = t14) : t14 = $[25];
  let t15;
  $[26] !== t13 || $[27] !== t6 || $[28] !== t7 ? (t15 = /* @__PURE__ */ jsxs(DiffViewPaneLayout, { ref: setBoundaryElement, style: t6, borderLeft: t7, children: [
    t13,
    t14
  ] }), $[26] = t13, $[27] = t6, $[28] = t7, $[29] = t15) : t15 = $[29];
  let t16;
  $[30] !== boundaryElement || $[31] !== t15 ? (t16 = /* @__PURE__ */ jsx(BoundaryElementProvider, { element: boundaryElement, children: t15 }), $[30] = boundaryElement, $[31] = t15, $[32] = t16) : t16 = $[32];
  let t17;
  return $[33] !== scrollElement || $[34] !== t16 ? (t17 = /* @__PURE__ */ jsx(ReviewChangesContext.Provider, { value: t4, children: /* @__PURE__ */ jsx(ChangeIndicatorsTracker, { children: /* @__PURE__ */ jsx(VirtualizerScrollInstanceProvider, { scrollElement, containerElement, children: t16 }) }) }), $[33] = scrollElement, $[34] = t16, $[35] = t17) : t17 = $[35], t17;
}), DiffViewDocument = (t0) => {
  const $ = c(52), {
    role,
    documentType,
  ...
  const compareValue = useCompareValue(t1), {
    data: releases
  } = useActiveReleases(), [patchChannel] = useState(_temp$K);
  let t2;
...
const Root$a = /* @__PURE__ */ styled(Layer).withConfig({
  displayName: "Root",
...
const Root$9 = /* @__PURE__ */ styled(Card).withConfig({
  displayName: "Root",
...
}), Root$8 = /* @__PURE__ */ styled(Card).withConfig({
  displayName: "Root",
...
const Root$7 = /* @__PURE__ */ styled(Layer).withConfig({
...
})(["position:sticky;bottom:0;"]), RootCard = /* @__PURE__ */ styled(Card).withConfig({
  ...
  `), Layout = /* @__PURE__ */ styled(Flex).withConfig({
  displayName: "Layout",
  ...
  `;
}), TitleTextSkeleton = /* @__PURE__ */ styled(TextSkeleton).withConfig({
  displayName: "TitleTextSkeleton",
  componentId: "sc-2mpzxb-3"
})(["width:66%;max-width:175px;"]), TitleText = /* @__PURE__ */ styled(Text).withConfig({
...
const Root$5 = /* @__PURE__ */ styled(Card).withConfig({
  displayName: "Root",
...
const DEFAULT_MESSAGE_KEY = "panes.resolving.default-message", Content$2 = /* @__PURE__ */ styled(Flex).withConfig({
  displayName: "Content",
...
function CommentsProviderWrapper(props) {
  ...
  const scopeId = t0, selectedCommentId = params?.comment, scheduledDraft = params?.scheduledDraft, paramsRef = useRef(params);
  let t1, t2;
  $[2] !== params ? (t1 = () => {
    paramsRef.current = params;
  }, t2 = [params], $[2] = params, $[3] = t1, $[4] = t2) : (t1 = $[3], t2 = $[4]), useLayoutEffect(t1, t2);
  let t3;
  ...
  if (!enabled) {
    let t62;
    return $[17] !== children ? (t62 = /* @__PURE__ */ jsx(Fragment, { children }), $[17] = children, $[18] = t62) : t62 = $[18], t62;
  }
  const t6 = inspector?.name === COMMENTS_INSPECTOR_NAME, t7 = connectionState === "connecting";
  let t8;
  return $[19] !== children || $[20] !== documentId || $[21] !== documentType || $[22] !== getCommentLink || $[23] !== handleClearSelectedComment || $[24] !== handleOpenCommentsInspector || $[25] !== onPathOpen || $[26] !== scopeId || $[27] !== selectedCommentId || $[28] !== t6 || $[29] !== t7 ? (t8 = /* @__PURE__ */ jsx(CommentsProvider, { documentId, documentType, getCommentLink, isCommentsOpen: t6, isConnecting: t7, onClearSelectedComment: handleClearSelectedComment, onCommentsOpen: handleOpenCommentsInspector, onPathOpen, selectedCommentId, sortOrder: "desc", type: "field", releaseId: scopeId, children }), $[19] = children, $[20] = documentId, $[21] = documentType, $[22] = getCommentLink, $[23] = handleClearSelectedComment, $[24] = handleOpenCommentsInspector, $[25] = onPathOpen, $[26] = scopeId, $[27] = selectedCommentId, $[28] = t6, $[29] = t7, $[30] = t8) : t8 = $[30], t8;
}
...
const SUPPORTED_CANVAS_LOCKED_ACTIONS = ["delete", "duplicate", "publish", "unpublish", "unlinkFromCanvas", "editInCanvas", "linkToCanvas", "schedule", "discardVersion", "unpublishVersion"];
...
function useStructureToolSetting(namespace, key, defaultValue) {
  ...
  if ($[3] !== defaultValue || $[4] !== keyValueStore || $[5] !== keyValueStoreKey) {
    let t22;
    $[7] !== defaultValue ? (t22 = (value) => value === null || value === "" ? defaultValue : value, $[7] = defaultValue, $[8] = t22) : t22 = $[8], t1 = keyValueStore.getKey(keyValueStoreKey).pipe(map$1(t22)), $[3] = defaultValue, $[4] = keyValueStore, $[5] = keyValueStoreKey, $[6] = t1;
  } else
    t1 = $[6];
...
}), MAX_NOTE_LENGTH = 150, DialogBody$1 = /* @__PURE__ */ styled(Box).withConfig({
...
const Image = /* @__PURE__ */ styled.img.withConfig({
  ...
  let t11;
  $[19] !== t10 ? (t11 = /* @__PURE__ */ jsx(Flex, { gap: 3, justify: "flex-end", paddingX: 4, paddingBottom: 4, children: /* @__PURE__ */ jsx(Button$1, { mode: "bleed", text: t10, autoFocus: !0, tone: "primary", href: "https://snty.link/canvas-docs", target: "_blank", rel: "noopener noreferrer", as: "a", iconRight: LaunchIcon }) }), $[19] = t10, $[20] = t11) : t11 = $[20];
  let t12;
  return $[21] !== t11 || $[22] !== t9 ? (t12 = /* @__PURE__ */ jsx(Card, { radius: 3, overflow: "hidden", ref, children: /* @__PURE__ */ jsxs(Container$1, { width: 0, children: [
    t4,
    t9,
    t11
...
function DocumentNotInVariantBanner() {
  ...
  } = useVariantDocumentOperations(), [status, setStatus] = useState("idle"), toast = useToast(), defaultPerspective = useGetDefaultPerspective();
  let t0;
  ...
  $[17] !== variantTitle ? (t6 = {
    title: variantTitle
  }, $[17] = variantTitle, $[18] = t6) : t6 = $[18];
  let t7;
  $[19] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t7 = {
    VariantBadge: _temp$C
  }, $[19] = t7) : t7 = $[19];
  let t8;
  $[20] !== t || $[21] !== t6 ? (t8 = /* @__PURE__ */ jsx(Text, { size: 1, children: /* @__PURE__ */ jsx(Translate, { i18nKey: "banners.variant.not-in-variant", t, values: t6, components: t7 }) }), $[20] = t, $[21] = t6, $[22] = t8) : t8 = $[22];
  let t9;
  ...
  let t10;
  return $[28] !== t8 || $[29] !== t9 ? (t10 = /* @__PURE__ */ jsx(Banner, { tone: "suggest", content: t8, action: t9 }), $[28] = t8, $[29] = t9, $[30] = t10) : t10 = $[30], t10;
}
function _temp$C(t0) {
  const {
    children
...
function VariantDefinitionNotFoundBanner(t0) {
  ...
  let t1;
  $[0] !== requestedVariantName ? (t1 = {
    name: requestedVariantName
  }, $[0] = requestedVariantName, $[1] = t1) : t1 = $[1];
  let t2;
  $[2] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t2 = {
    VariantName: _temp$B
  }, $[2] = t2) : t2 = $[2];
  let t3;
  return $[3] !== t || $[4] !== t1 ? (t3 = /* @__PURE__ */ jsx(Banner, { tone: "caution", icon: WarningOutlineIcon, content: /* @__PURE__ */ jsx(Text, { size: 1, children: /* @__PURE__ */ jsx(Translate, { i18nKey: "banners.variant.definition-not-found", t, values: t1, components: t2 }) }) }), $[3] = t, $[4] = t1, $[5] = t3) : t3 = $[5], t3;
}
function _temp$B(t0) {
  const {
    children
...
const TitleContainer = /* @__PURE__ */ styled(Stack).withConfig({
  ...
  const $ = c(112), {
    ...
    selectedPerspective
  } = usePerspective(), documentStore = useDocumentStore();
  let t0;
  $[0] !== targetDocumentState ? (t0 = getTargetScopeId(targetDocumentState), $[0] = targetDocumentState, $[1] = t0) : t0 = $[1];
  const scopeId = t0, presence = useDocumentPresence(documentId), {
    title
  ...
  let t17;
  $[44] !== documentId || $[45] !== documentStore || $[46] !== documentType || $[47] !== patchChannel || $[48] !== scopeId ? (t17 = [documentId, documentStore, documentType, patchChannel, scopeId], $[44] = documentId, $[45] = documentStore, $[46] = documentType, $[47] = patchChannel, $[48] = scopeId, $[49] = t17) : t17 = $[49], useEffect(t16, t17);
  ...
  const handleInitialValue = useEffectEvent(t18);
  let t19;
  $[53] !== handleInitialValue || $[54] !== hasRev ? (t19 = () => {
    hasRev && handleInitialValue();
  }, $[53] = handleInitialValue, $[54] = hasRev, $[55] = t19) : t19 = $[55];
  let t20;
  $[56] !== hasRev ? (t20 = [hasRev], $[56] = hasRev, $[57] = t20) : t20 = $[57], useEffect(t19, t20);
  ...
  let t23;
  $[63] !== formRef || $[64] !== hasFocusedAnyPath || $[65] !== ready || $[66] !== t22 ? (t23 = [hasFocusedAnyPath, formRef, t22, ready], $[63] = formRef, $[64] = hasFocusedAnyPath, $[65] = ready, $[66] = t22, $[67] = t23) : t23 = $[67], useEffect(t21, t23);
  let t24;
  $[68] !== focusPath.length ? (t24 = () => {
    focusPath.length !== 0 && setHasFocusedAnyPath(!0);
  }, $[68] = focusPath.length, $[69] = t24) : t24 = $[69];
  let t25;
  $[70] !== focusPath ? (t25 = [focusPath], $[70] = focusPath, $[71] = t25) : t25 = $[71], useEffect(t24, t25);
  let t26;
  $[72] !== ref ? (t26 = (node) => {
  ...
  let t29;
  $[102] !== setRef || $[103] !== t27 || $[104] !== t28 ? (t29 = /* @__PURE__ */ jsx(Box, { as: "form", onSubmit: preventDefault, ref: setRef, "data-testid": "form-view", "data-read-only": t27, children: t28 }), $[102] = setRef, $[103] = t27, $[104] = t28, $[105] = t29) : t29 = $[105];
  let t30;
  $[106] !== margins || $[107] !== t29 ? (t30 = /* @__PURE__ */ jsx(PresenceOverlay, { margins, children: t29 }), $[106] = margins, $[107] = t29, $[108] = t30) : t30 = $[108];
  let t31;
  return $[109] !== hidden || $[110] !== t30 ? (t31 = /* @__PURE__ */ jsx(FormContainer, { hidden, children: t30 }), $[109] = hidden, $[110] = t30, $[111] = t31) : t31 = $[111], t31;
});
...
const FavoriteToggle = (t0) => {
  ...
  const inspectDialog = t8, showInspector = !!(!collapsed && inspector), {
    ...
    selectedPerspectiveName,
    selectedPerspective
  } = usePerspective(), hasDocumentInRelease = selectedPerspectiveName && targetDocumentState.status === "ready" && !!targetDocumentState.targetDocument, t9 = params?.historyVersion;
  let t10;
  ...
  $[40] !== activeView.type || $[41] !== archivedScheduledDraftRelease || $[42] !== displayed || $[43] !== documentId || $[44] !== editState || $[45] !== filteredReleases || $[46] !== hasDocumentInRelease || $[47] !== isPausedDraft || $[48] !== isPermissionsLoading || $[49] !== params?.historyVersion || $[50] !== permissions?.granted || $[51] !== ready || $[52] !== requiredPermission || $[53] !== schemaType || $[54] !== selectedPerspective || $[55] !== selectedPerspectiveName || $[56] !== selectedReleaseId || $[57] !== targetDocumentState || $[58] !== value._id || $[59] !== workspace ? (t12 = () => {
    ...
    if (targetDocumentState.status === "variant-missing")
      return /* @__PURE__ */ jsx(DocumentNotInVariantBanner, {});
    if (targetDocumentState.status === "variant-definition-document-not-found")
      return /* @__PURE__ */ jsx(VariantDefinitionNotFoundBanner, { requestedVariantName: targetDocumentState.requestedVariantName });
  ...
  const banners = t13;
  let t14;
  $[63] !== documentScrollElement ? (t14 = {
    documentScrollElement
  }, $[63] = documentScrollElement, $[64] = t14) : t14 = $[64];
  const portalElements = t14, showFormView = features.resizablePanes || !showInspector;
  let t15;
  $[65] !== activeViewNode || $[66] !== banners || $[67] !== documentScrollElement || $[68] !== footer || $[69] !== formViewHidden || $[70] !== inspectDialog || $[71] !== layoutCollapsed || $[72] !== margins || $[73] !== portalElement || $[74] !== portalElements || $[75] !== showFormView ? (t15 = showFormView && /* @__PURE__ */ jsxs(Flex, { height: "fill", direction: "column", flex: 2, children: [
  ...
  let t16;
  $[77] !== documentId || $[78] !== rootElement || $[79] !== schemaType || $[80] !== showInspector ? (t16 = showInspector && /* @__PURE__ */ jsx(BoundaryElementProvider, { element: rootElement, children: /* @__PURE__ */ jsx(DocumentInspectorPanel, { documentId, documentType: schemaType.name, flex: 1 }) }), $[77] = documentId, $[78] = rootElement, $[79] = schemaType, $[80] = showInspector, $[81] = t16) : t16 = $[81];
  let t17;
  return $[82] !== t15 || $[83] !== t16 ? (t17 = /* @__PURE__ */ jsx(PaneContent, { children: /* @__PURE__ */ jsxs(Flex, { height: "fill", children: [
    t15,
    t16
...
const useHistoryRestoreAction = (t0) => {
  const $ = c(28), {
    ...
    revisionNotFound,
    targetDocumentState
  } = useDocumentPane(), isTargetReady = targetDocumentState.status === "ready";
  let t1;
  $[0] !== targetDocumentState ? (t1 = getPairTarget(targetDocumentState), $[0] = targetDocumentState, $[1] = t1) : t1 = $[1];
  const {
    restore
  } = useDocumentOperation(id, type, t1), event = useDocumentOperationEvent(id, type), {
    navigateIntent
  ...
  }, t5 = [event, id, navigateIntent, type], $[6] = event, $[7] = id, $[8] = navigateIntent, $[9] = type, $[10] = t4, $[11] = t5) : (t4 = $[10], t5 = $[11]), useEffect(t4, t5);
  let t6;
...
function CopyDocumentActions() {
  const $ = c(43), {
    ...
    editState
  } = useDocumentPane(), targetDocumentState = useTargetDocumentState(documentId);
  let t0;
  $[0] !== documentId ? (t0 = {
    documentId
  }, $[0] = documentId, $[1] = t0) : t0 = $[1];
  const {
    data: existingDocumentIds,
    loading: documentVersionsLoading
  } = useDocumentVersions(t0), {
    selectedReleaseId,
    selectedPerspectiveName
  } = usePerspective(), {
    params
  ...
  let t5;
  $[24] !== t4 ? (t5 = /* @__PURE__ */ jsx(Button$1, { icon: ShareIcon, mode: "bleed", tooltipProps: {
    content: t4
  }, "data-testid": "copy-document-actions-button" }), $[24] = t4, $[25] = t5) : t5 = $[25];
  let t6;
  $[26] !== t ? (t6 = t("action.copy-link-to-document.label"), $[26] = t, $[27] = t6) : t6 = $[27];
  let t7;
  $[28] !== handleCopyLink || $[29] !== t6 ? (t7 = /* @__PURE__ */ jsx(MenuItem$1, { icon: LinkIcon, onClick: handleCopyLink, text: t6, "data-testid": "copy-link-to-document" }), $[28] = handleCopyLink, $[29] = t6, $[30] = t7) : t7 = $[30];
  let t8;
  $[31] !== t ? (t8 = t("action.copy-document-id.label"), $[31] = t, $[32] = t8) : t8 = $[32];
  let t9;
  $[33] !== handleCopyId || $[34] !== t8 ? (t9 = /* @__PURE__ */ jsx(MenuItem$1, { icon: TargetIcon, onClick: handleCopyId, text: t8, "data-testid": "copy-document-id" }), $[33] = handleCopyId, $[34] = t8, $[35] = t9) : t9 = $[35];
  let t10;
  $[36] !== t7 || $[37] !== t9 ? (t10 = /* @__PURE__ */ jsxs(Menu, { children: [
    t7,
    t9
  ] }), $[36] = t7, $[37] = t9, $[38] = t10) : t10 = $[38];
  let t11;
  ...
  let t12;
  return $[40] !== t10 || $[41] !== t5 ? (t12 = /* @__PURE__ */ jsx(MenuButton, { id: "copy-document-actions", button: t5, menu: t10, popover: t11 }), $[40] = t10, $[41] = t5, $[42] = t12) : t12 = $[42], t12;
}
...
}), STORAGE_NAMESPACE = ["studio", "document-group-inventory", "hint"], COUNT_KEY = ["session-count"], DISPLAYED_KEY = ["has-displayed"], SESSION_LIMIT = 3, SUPPRESSED_COUNT = -1, browserStorageAdapter = {
  readCount: async () => {
...
function hintStatus({
  ...
  return from(combineLatest([readCount(), readHasDisplayed()])).pipe(map(([count, hasDisplayed]) => [count, sessionCountToStatus(count), hasDisplayed]), tap$1(async ([value, status, hasDisplayed]) => {
    status === "active" && !hasDisplayed && await Promise.all([writeCount(value + 1), writeHasDisplayed(!0)]);
  }), map(([, status]) => status));
}
function suppressHint({
  writeCount
}) {
...
const DocumentGroupInventoryHint = () => {
  ...
  } = useDocumentPane(), telemetry = useTelemetry();
  let t0;
  if ($[0] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t0 = hintStatus(browserStorageAdapter), $[0] = t0) : t0 = $[0], useObservable(t0) === "inactive")
    return null;
  let t1;
  ...
  let t2;
  $[4] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t2 = /* @__PURE__ */ jsx(InfoOutlineIcon, {}), $[4] = t2) : t2 = $[4];
  let t3;
  $[5] !== t ? (t3 = t("document-group-inventory.onboarding-hint"), $[5] = t, $[6] = t3) : t3 = $[6];
  let t4;
  $[7] !== t3 ? (t4 = /* @__PURE__ */ jsx(Text, { size: 1, weight: "medium", children: /* @__PURE__ */ jsxs(Flex, { gap: 2, align: "center", flex: "none", justify: "flex-end", children: [
    t2,
    " ",
    t3
  ] }) }), $[7] = t3, $[8] = t4) : t4 = $[8];
  let t5;
  return $[9] !== t1 || $[10] !== t4 ? (t5 = /* @__PURE__ */ jsx(TextButton, { onClick: t1, children: t4 }), $[9] = t1, $[10] = t4, $[11] = t5) : t5 = $[11], t5;
}, TextButton = /* @__PURE__ */ styled.button.withConfig({
  displayName: "TextButton",
  componentId: "sc-zuzmeh-0"
})(({
  theme
}) => css(["display:inline-block;vertical-align:middle;appearance:none;border:0;margin:0;padding:0;outline:none;all:unset;flex:none;white-space:nowrap;color:var(--card-badge-suggest-fg-color);cursor:pointer;*{color:inherit;}svg[data-sanity-icon]{color:currentColor;}"])), RhombusIcon = forwardRef(function(props, ref) {
  const $ = c(4);
  let t0;
...
}), TargetBadge = /* @__PURE__ */ styled(Card).withConfig({
  displayName: "TargetBadge",
  componentId: "sc-jnn8ci-0"
})(["display:inline-flex;align-items:center;flex:none;"]), BadgeContainer = /* @__PURE__ */ styled(Flex).withConfig({
...
const PerspectiveBadgeLabel = memo(function(t0) {
  const $ = c(20), {
    selectedPerspective
  } = t0, {
    t
  ...
  if (isPublishedPerspective(selectedPerspective) || isDraftPerspective(selectedPerspective)) {
    ...
    let t22;
    return $[3] !== t12 ? (t22 = /* @__PURE__ */ jsx(BadgeContainer, { padding: 2, children: /* @__PURE__ */ jsx(Text, { size: 1, weight: "medium", children: t12 }) }), $[3] = t12, $[4] = t22) : t22 = $[4], t22;
  }
  if (isReleaseDocument(selectedPerspective)) {
    let t12;
    $[5] !== selectedPerspective ? (t12 = /* @__PURE__ */ jsx(ReleaseAvatarIcon, { release: selectedPerspective }), $[5] = selectedPerspective, $[6] = t12) : t12 = $[6];
    ...
    let t5;
    $[10] !== t22 || $[11] !== t3 ? (t5 = /* @__PURE__ */ jsx(ReleaseTitle, { title: t22, fallback: t3, enableTooltip: !1, textProps: t4 }), $[10] = t22, $[11] = t3, $[12] = t5) : t5 = $[12];
    let t6;
    return $[13] !== t12 || $[14] !== t5 ? (t6 = /* @__PURE__ */ jsxs(BadgeContainer, { gap: 2, paddingY: 1, paddingRight: 2, align: "center", children: [
      t12,
      t5
  ...
  let t2;
  return $[18] !== t1 ? (t2 = /* @__PURE__ */ jsx(BadgeContainer, { padding: 2, children: /* @__PURE__ */ jsx(Text, { size: 1, textOverflow: "ellipsis", weight: "medium", children: t1 }) }), $[18] = t1, $[19] = t2) : t2 = $[19], t2;
}), VariantBadgeLabel = memo(function(t0) {
  const $ = c(5), {
    variant
  } = t0;
  let t1;
  $[0] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t1 = /* @__PURE__ */ jsx(Text, { size: 0, children: /* @__PURE__ */ jsx(RhombusIcon, {}) }), $[0] = t1) : t1 = $[0];
  let t2;
  $[1] !== variant ? (t2 = getVariantTitle(variant), $[1] = variant, $[2] = t2) : t2 = $[2];
  let t3;
  return $[3] !== t2 ? (t3 = /* @__PURE__ */ jsx(BadgeContainer, { padding: 2, children: /* @__PURE__ */ jsxs(Flex, { align: "center", gap: 2, children: [
    t1,
    /* @__PURE__ */ jsx(Text, { size: 1, weight: "medium", children: t2 })
  ] }) }), $[3] = t2, $[4] = t3) : t3 = $[4], t3;
}), DocumentTargetBadges = memo(function() {
  const $ = c(12), {
    targetDocumentState
  } = useDocumentPane(), {
    selectedPerspective
  ...
  let t1;
  $[2] !== selectedPerspective ? (t1 = /* @__PURE__ */ jsx(PerspectiveBadgeLabel, { selectedPerspective }), $[2] = selectedPerspective, $[3] = t1) : t1 = $[3];
  let t2;
  $[4] !== t0 || $[5] !== t1 ? (t2 = /* @__PURE__ */ jsx(TargetBadge, { tone: t0, border: !0, radius: 4, "data-ui": "DocumentTargetPerspectiveBadge", children: t1 }), $[4] = t0, $[5] = t1, $[6] = t2) : t2 = $[6];
  let t3;
  $[7] !== selectedVariant ? (t3 = selectedVariant ? /* @__PURE__ */ jsx(TargetBadge, { tone: "suggest", border: !0, radius: 4, "data-ui": "DocumentTargetVariantBadge", children: /* @__PURE__ */ jsx(VariantBadgeLabel, { variant: selectedVariant }) }) : null, $[7] = selectedVariant, $[8] = t3) : t3 = $[8];
  let t4;
  return $[9] !== t2 || $[10] !== t3 ? (t4 = /* @__PURE__ */ jsxs(Flex, { align: "center", flex: "none", gap: 2, paddingRight: 1, children: [
    t2,
    t3
...
function useDocumentPerspectiveList() {
  ...
  const {
    ...
    data: documentVersionsIds
  } = useDocumentVersions(t2), onlyHasVersions = documentVersionsIds.length > 0 && !documentVersionsIds.some(_temp$w), workspace = useWorkspace(), {
    onSetScheduledDraftPerspective
  } = useSingleDocRelease();
  let t3;
  ...
  const isDraftDisabled = t9, isDraftModelEnabled = workspace.document.drafts?.enabled, {
    filteredVersionIds,
    getVersionDisplay: getAgentVersionDisplay
  } = useAgentVersionDisplay(documentVersionsIds, selectedPerspectiveName);
  let t10;
  ...
  $[28] !== getAgentVersionDisplay || $[29] !== variants2 ? (t11 = (version_0) => {
    if (!version_0._system.variant)
      return getAgentVersionDisplay(version_0._id);
  ...
  $[35] !== setVariant || $[36] !== variants2 ? (t14 = (version_3) => {
    const variantId_0 = version_3._system.variant?._ref, variant_0 = variantId_0 ? variants2.get(variantId_0) : void 0, versionBundle = version_3._system.bundleId, perspective = versionBundle || "published";
    setVariant({
...
function _temp2$f(version_1) {
  if (isPublishedId(version_1._id) || isDraftId(version_1._id))
    return !1;
...
function NonReleaseVersionsSelect(props) {
  ...
  $[7] !== documentType || $[8] !== getVersionDisplay || $[9] !== onCopyToDraftsNavigate || $[10] !== onSelectBundle || $[11] !== releases || $[12] !== releasesLoading || $[13] !== selectedNonReleaseVersion ? (t4 = selectedNonReleaseVersion && (() => {
    ...
    return /* @__PURE__ */ jsx(VersionChip, { selected: !0, text: versionDisplay?.displayName ?? bundleId, tone: versionDisplay?.tone ?? "default", onClick: () => onSelectBundle(selectedNonReleaseVersion), onCopyToDraftsNavigate, contextValues: {
  ...
  if ($[20] !== documentType || $[21] !== getVersionDisplay || $[22] !== onCopyToDraftsNavigate || $[23] !== onSelectBundle || $[24] !== otherNonReleaseVersions || $[25] !== releases || $[26] !== releasesLoading || $[27] !== selectedPerspective) {
    ...
    $[29] !== documentType || $[30] !== getVersionDisplay || $[31] !== onCopyToDraftsNavigate || $[32] !== onSelectBundle || $[33] !== releases || $[34] !== releasesLoading || $[35] !== selectedPerspective ? (t72 = (nonReleaseVersion) => {
      ...
      return /* @__PURE__ */ jsx(VersionChip, { selected, text: versionDisplay_0?.displayName ?? scopeId, disabled: !1, contextMenuPortal: !1, tone: versionDisplay_0?.tone ?? "default", onClick: () => onSelectBundle(nonReleaseVersion), onCopyToDraftsNavigate, contextValues: {
    ...
    t6 = $[28];
  let t7;
  $[37] !== t6 ? (t7 = /* @__PURE__ */ jsx(Container$1, { width: 1, children: /* @__PURE__ */ jsx(Flex, { padding: 3, gap: 2, wrap: "wrap", children: t6 }) }), $[37] = t6, $[38] = t7) : t7 = $[38];
  let t8;
  $[39] !== nonReleaseDropdownOpen || $[40] !== popoverReferenceElement || $[41] !== t7 ? (t8 = /* @__PURE__ */ jsx(Popover, { animate: !1, open: nonReleaseDropdownOpen, portal: !0, arrow: !0, ref: popoverRef, placement: "bottom", referenceElement: popoverReferenceElement, zOffset: 10, content: t7 }), $[39] = nonReleaseDropdownOpen, $[40] = popoverReferenceElement, $[41] = t7, $[42] = t8) : t8 = $[42];
  let t9;
  return $[43] !== t4 || $[44] !== t5 || $[45] !== t8 ? (t9 = /* @__PURE__ */ jsxs(Fragment, { children: [
    t4,
    t5,
    t8
...
const TooltipContent$1 = (t0) => {
  ...
  $[37] !== displayed?._id || $[38] !== documentType || $[39] !== filteredReleases.inCreation || $[40] !== filteredReleases.notCurrentReleases || $[41] !== handleCopyToDraftsNavigate || $[42] !== loading || $[43] !== t ? (t8 = filteredReleases.inCreation && /* @__PURE__ */ jsx(ReleaseTitle, { title: filteredReleases.inCreation.metadata.title, fallback: t("release.placeholder-untitled-release"), enableTooltip: !1, children: (t92) => {
    ...
    ] }) : /* @__PURE__ */ jsx(TooltipContent$1, { release: filteredReleases.inCreation }), selected: !0, onClick: _temp$u, locked: !1, tone: getReleaseTone(filteredReleases.inCreation), text: displayTitle, onCopyToDraftsNavigate: handleCopyToDraftsNavigate, contextValues: {
  ...
  let t11;
  $[58] !== documentType || $[59] !== filteredReleases.notCurrentReleases || $[60] !== getVersionDisplay || $[61] !== handleCopyToDraftsNavigate || $[62] !== loading || $[63] !== nonReleaseVersions || $[64] !== selectedPerspectiveName || $[65] !== t10 ? (t11 = /* @__PURE__ */ jsx(NonReleaseVersionsSelect, { nonReleaseVersions, selectedPerspective: selectedPerspectiveName, onSelectBundle: t10, onCopyToDraftsNavigate: handleCopyToDraftsNavigate, releases: filteredReleases.notCurrentReleases, releasesLoading: loading, documentType, getVersionDisplay, mode: "versions" }), $[58] = documentType, $[59] = filteredReleases.notCurrentReleases, $[60] = getVersionDisplay, $[61] = handleCopyToDraftsNavigate, $[62] = loading, $[63] = nonReleaseVersions, $[64] = selectedPerspectiveName, $[65] = t10, $[66] = t11) : t11 = $[66];
  let t12;
  $[67] !== selectedVariantDisplay ? (t12 = selectedVariantDisplay ? /* @__PURE__ */ jsx(Chip, { selected: !0, tone: selectedVariantDisplay.tone, mode: "bleed", text: selectedVariantDisplay.displayName }) : null, $[67] = selectedVariantDisplay, $[68] = t12) : t12 = $[68];
  let t13;
  $[69] !== documentType || $[70] !== filteredReleases.notCurrentReleases || $[71] !== getVersionDisplay || $[72] !== handleCopyToDraftsNavigate || $[73] !== handleVariantSelectionChange || $[74] !== loading || $[75] !== selectedPerspectiveName || $[76] !== variantVersions ? (t13 = variantVersions.length > 0 ? /* @__PURE__ */ jsx(NonReleaseVersionsSelect, { nonReleaseVersions: variantVersions, selectedPerspective: selectedPerspectiveName, onSelectBundle: handleVariantSelectionChange, onCopyToDraftsNavigate: handleCopyToDraftsNavigate, releases: filteredReleases.notCurrentReleases, releasesLoading: loading, documentType, getVersionDisplay, mode: "variants" }) : null, $[69] = documentType, $[70] = filteredReleases.notCurrentReleases, $[71] = getVersionDisplay, $[72] = handleCopyToDraftsNavigate, $[73] = handleVariantSelectionChange, $[74] = loading, $[75] = selectedPerspectiveName, $[76] = variantVersions, $[77] = t13) : t13 = $[77];
  let t14;
  return $[78] !== t11 || $[79] !== t12 || $[80] !== t13 || $[81] !== t6 || $[82] !== t7 || $[83] !== t8 || $[84] !== t9 ? (t14 = /* @__PURE__ */ jsxs(Fragment, { children: [
    t6,
    t7,
    t8,
    t9,
...
const HorizontalScroller = /* @__PURE__ */ styled(Card).withConfig({
  ...
  return $[20] !== BackLink2 || $[21] !== backButton || $[22] !== collapsed || $[23] !== connectionState || $[24] !== contextMenuNodes || $[25] !== documentLevelPresence || $[26] !== editState || $[27] !== handleFocusPane || $[28] !== hasDocumentGroupInventory || $[29] !== isMaximizedPane || $[30] !== menuButtonNodes || $[31] !== onPaneClose || $[32] !== onPaneSplit || $[33] !== onSetMaximizedPane || $[34] !== paneHeaderZIndex || $[35] !== ref || $[36] !== referenceElement || $[37] !== schemaType || $[38] !== showGradient || $[39] !== showPaneGroupCloseButton || $[40] !== showSplitPaneButton || $[41] !== showSplitPaneCloseButton || $[42] !== t || $[43] !== tabIndex || $[44] !== unstable_languageFilter ? (t7 = /* @__PURE__ */ jsx(TooltipDelayGroupProvider, { children: collapsed ? /* @__PURE__ */ jsx(PaneHeader$1, { border: !0, ref, loading: connectionState === "connecting" && !editState?.draft && !editState?.published, title, tabIndex, backButton }) : /* @__PURE__ */ jsx(Card, { hidden: collapsed, style: {
  ...
  }, borderBottom: !0, children: /* @__PURE__ */ jsxs(Flex, { gap: 3, paddingY: 3, justify: "space-between", align: "center", children: [
    ...
    hasDocumentGroupInventory && /* @__PURE__ */ jsx(HorizontalScroller, { $showGradient: !1, children: /* @__PURE__ */ jsxs(Flex, { flex: 1, gap: 2, align: "center", overflow: "auto", paddingX: 3, "data-testid": "document-target-badges", style: {
      minWidth: 0
    }, children: [
      /* @__PURE__ */ jsx(Box, { flex: "none", children: /* @__PURE__ */ jsx(DocumentTargetBadges, {}) }),
      /* @__PURE__ */ jsx(Box, { flex: "none", children: /* @__PURE__ */ jsx(DocumentGroupInventoryHint, {}) })
    ] }) }),
...
function ReferencePreviewLink(props) {
  ...
  let t5;
  $[6] !== documentPreviewStore || $[7] !== t3 || $[8] !== t4 || $[9] !== type || $[10] !== value ? (t5 = /* @__PURE__ */ jsx(PaneItemPreview, { documentPreviewStore, icon: t3, layout: "compact", presence: t4, schemaType: type, value }), $[6] = documentPreviewStore, $[7] = t3, $[8] = t4, $[9] = type, $[10] = value, $[11] = t5) : t5 = $[11];
  let t6;
  return $[12] !== Link2 || $[13] !== onClick || $[14] !== t5 ? (t6 = /* @__PURE__ */ jsx(PreviewCard, { __unstable_focusRing: !0, as: Link2, "data-as": "a", onClick, radius: 2, children: t5 }), $[12] = Link2, $[13] = onClick, $[14] = t5, $[15] = t6) : t6 = $[15], t6;
}
...
const EllipsisText = /* @__PURE__ */ styled(Text).withConfig({
  ...
  let t11;
  $[27] !== documentVariant || $[28] !== release?.metadata?.title || $[29] !== systemTitle || $[30] !== versionId ? (t11 = documentVariant === "version" ? /* @__PURE__ */ jsx(ReleaseTitle, { title: release?.metadata?.title, fallback: getVersionFromId(versionId), children: _temp$q }) : /* @__PURE__ */ jsx(EllipsisText, { size: 1, weight: "medium", textOverflow: "ellipsis", children: systemTitle }), $[27] = documentVariant, $[28] = release?.metadata?.title, $[29] = systemTitle, $[30] = versionId, $[31] = t11) : t11 = $[31];
  let t12;
...
const DocumentPublished = defineEvent({
...
}, DELETE_OUTCOME_TIMEOUT = 3e4, useDeleteAction = (t0) => {
  const $ = c(48), {
    id,
    type,
    draft
  ...
  const {
    delete: deleteOp
  } = useDocumentOperation(id, type, t2), [isDeleting, setIsDeleting] = useState(!1), [isConfirmDialogOpen, setConfirmDialogOpen] = useState(!1), documentStore = useDocumentStore(), telemetry = useTelemetry(), {
    t
  } = useTranslation(structureLocaleNamespace);
  let t3;
  $[5] !== id ? (t3 = {
  ...
  const {
    sortedDocumentList
  } = useDocumentVersionTypeSortedList(t3);
  let t4;
  ...
  $[10] !== deleteOp || $[11] !== documentStore.pair || $[12] !== id || $[13] !== telemetry || $[14] !== type ? (t6 = (versions, referenceCounts) => {
    ...
    setConfirmDialogOpen(!1), setIsDeleting(!0), telemetry.log(DocumentDeleted, {
      ...referenceInfo,
      stage: "confirmed"
    }), firstValueFrom(documentStore.pair.operationEvents(id, type).pipe(filter(_temp$p), map(_temp2$c), timeout({
      first: DELETE_OUTCOME_TIMEOUT
    }), catchError(_temp3$9))).then((outcome) => {
  ...
  bb0: {
    ...
    if (!isPermissionsLoading && !permissions?.granted) {
      ...
      let t112;
      $[23] !== currentUser ? (t112 = /* @__PURE__ */ jsx(InsufficientPermissionsMessage, { context: "delete-document", currentUser }), $[23] = currentUser, $[24] = t112) : t112 = $[24];
      let t122;
...
const DISABLED_REASON_KEY$2 = {
  ...
  const {
    discardChanges
  } = useDocumentOperation(id, type, t2), [isConfirmDialogOpen, setConfirmDialogOpen] = useState(!1);
  let t3;
  ...
  bb0: {
    ...
    if (!isPermissionsLoading && !permissions?.granted) {
      ...
      let t92;
      $[14] !== currentUser ? (t92 = /* @__PURE__ */ jsx(InsufficientPermissionsMessage, { context: "discard-changes", currentUser }), $[14] = currentUser, $[15] = t92) : t92 = $[15];
      let t102;
      $[16] !== t82 || $[17] !== t92 ? (t102 = {
        tone: "critical",
        icon: ResetIcon,
    ...
    $[24] !== handleConfirm || $[25] !== isConfirmDialogOpen || $[26] !== publishedCounterpartExists ? (t12 = isConfirmDialogOpen && {
      type: "custom",
      component: /* @__PURE__ */ jsx(ConfirmDiscardDialog, { onCancel: handleCancel, onConfirm: handleConfirm, publishedExists: publishedCounterpartExists })
...
const DISABLED_REASON_KEY$1 = {
  ...
  const {
    duplicate
  } = useDocumentOperation(id, type, t2), {
    navigateIntent
  ...
  const [permissions, isPermissionsLoading] = useDocumentPairPermissions(t3), {
    t
  ...
  bb0: {
    if (!isPermissionsLoading && !permissions?.granted) {
      ...
      let t72;
      $[17] !== currentUser ? (t72 = /* @__PURE__ */ jsx(InsufficientPermissionsMessage, { context: "duplicate-document", currentUser }), $[17] = currentUser, $[18] = t72) : t72 = $[18];
      let t82;
      $[19] !== t62 || $[20] !== t72 ? (t82 = {
        icon: CopyIcon,
        disabled: !0,
...
const usePublishAction = (props) => {
  ...
  const {
    publish
  } = useDocumentOperation(id, type, t1), validationStatus = useValidationStatus(value._id, type, !release), syncState = useSyncState(id, type, scopeId), editState = useEditState(documentId, documentType, "default", scopeId), {
    t
  } = useTranslation(structureLocaleNamespace);
  let t2;
  ...
  const hasValidationErrors = t3, [publishScheduled, setPublishScheduled] = useState(!1), isSyncing = syncState.isSyncing, isValidating = validationStatus.isValidating;
  let t4;
  ...
  let t8;
  $[34] !== doPublish || $[35] !== hasValidationErrors || $[36] !== isSyncing || $[37] !== isValidating || $[38] !== publishScheduled || $[39] !== revision || $[40] !== t || $[41] !== toast || $[42] !== validationStatus.isValidating || $[43] !== validationStatus.revision ? (t8 = [isSyncing, doPublish, hasValidationErrors, publishScheduled, validationStatus.revision, revision, isValidating, validationStatus.isValidating, toast, t], $[34] = doPublish, $[35] = hasValidationErrors, $[36] = isSyncing, $[37] = isValidating, $[38] = publishScheduled, $[39] = revision, $[40] = t, $[41] = toast, $[42] = validationStatus.isValidating, $[43] = validationStatus.revision, $[44] = t8) : t8 = $[44], useEffect(t7, t8);
  let t9;
  ...
  let t10;
  $[50] !== changesOpen || $[51] !== currentPublishRevision || $[52] !== id || $[53] !== publishState || $[54] !== telemetry ? (t10 = [changesOpen, publishState, currentPublishRevision, telemetry, id], $[50] = changesOpen, $[51] = currentPublishRevision, $[52] = id, $[53] = publishState, $[54] = telemetry, $[55] = t10) : t10 = $[55], useEffect(t9, t10);
  ...
  let t13;
  $[61] !== id || $[62] !== isWaitingToPublish || $[63] !== t12 || $[64] !== telemetry ? (t13 = [isWaitingToPublish, telemetry, id, t12], $[61] = id, $[62] = isWaitingToPublish, $[63] = t12, $[64] = telemetry, $[65] = t13) : t13 = $[65], useEffect(t11, t13);
  let t14;
  ...
  bb0: {
    ...
    if (!isPermissionsLoading && !permissions?.granted) {
      ...
      let t172;
      $[85] !== currentUser ? (t172 = /* @__PURE__ */ jsx(InsufficientPermissionsMessage, { context: "publish-document", currentUser }), $[85] = currentUser, $[86] = t172) : t172 = $[86];
      let t182;
  ...
  bb0: {
    if (isConfirmDialogOpen) {
      ...
      $[11] !== handleConfirm || $[12] !== t72 || $[13] !== type ? (t82 = {
        ...
        content: /* @__PURE__ */ jsx(ConfirmDeleteDialogContainer, { id: t72, type, action: "unpublish", onCancel: handleCancel, onConfirm: handleConfirm })
...
const documentGroupInventoryComponents = {
  ...
  const $ = c(55), {
    ...
    params
  } = usePaneRouter(), showingRevision = !!params?.rev, perspectiveList = useDocumentPerspectiveList(), client = useClient(DEFAULT_STUDIO_CLIENT_OPTIONS), documentStore = useDocumentStore();
  let t0;
  ...
  let t6;
  $[29] !== documentType || $[30] !== hasDocumentGroupInventory || $[31] !== isDocumentGroupInventoryActive || $[32] !== perspectiveList || $[33] !== referringDocuments$ || $[34] !== setIsDocumentGroupInventoryActive || $[35] !== targetDocumentId ? (t6 = hasDocumentGroupInventory && typeof targetDocumentId < "u" && /* @__PURE__ */ jsx(DocumentGroupInventoryAction, { documentId: targetDocumentId, portalElementName: DOCUMENT_PANEL_PORTAL_ELEMENT, isDocumentGroupInventoryActive, setIsDocumentGroupInventoryActive, children: /* @__PURE__ */ jsx(DocumentGroupInventory, { documentId: targetDocumentId, documentType, portalElementName: DOCUMENT_PANEL_PORTAL_ELEMENT, perspectiveList, referringDocuments$, components: documentGroupInventoryComponents }) }), $[29] = documentType, $[30] = hasDocumentGroupInventory, $[31] = isDocumentGroupInventoryActive, $[32] = perspectiveList, $[33] = referringDocuments$, $[34] = setIsDocumentGroupInventoryActive, $[35] = targetDocumentId, $[36] = t6) : t6 = $[36];
  let t7;
  $[37] !== disabled || $[38] !== firstActionState || $[39] !== showFirstActionButton || $[40] !== tooltipContent ? (t7 = showFirstActionButton && /* @__PURE__ */ jsx(LayerProvider, { zOffset: 200, children: /* @__PURE__ */ jsx(Tooltip, { disabled: !tooltipContent, content: tooltipContent, placement: "top", children: /* @__PURE__ */ jsx(Stack, { children: /* @__PURE__ */ jsx(Button$1, { "data-testid": `action-${toLowerCaseNoSpaces(firstActionState.label)}`, disabled: disabled || !!firstActionState.disabled, icon: firstActionState.icon, onClick: firstActionState.onHandle, ref: setButtonElement, text: firstActionState.label, tone: firstActionState.tone || "primary" }) }) }) }), $[37] = disabled, $[38] = firstActionState, $[39] = showFirstActionButton, $[40] = tooltipContent, $[41] = t7) : t7 = $[41];
  let t8;
  $[42] !== disabled || $[43] !== sideMenuItems ? (t8 = sideMenuItems.length > 0 && /* @__PURE__ */ jsx(ActionMenuButton, { actionStates: sideMenuItems, disabled }), $[42] = disabled, $[43] = sideMenuItems, $[44] = t8) : t8 = $[44];
  let t9;
  $[45] !== buttonElement || $[46] !== firstActionState || $[47] !== showFirstActionButton ? (t9 = showFirstActionButton && firstActionState && firstActionState.dialog && /* @__PURE__ */ jsx(ActionStateDialog, { dialog: firstActionState.dialog, referenceElement: buttonElement }), $[45] = buttonElement, $[46] = firstActionState, $[47] = showFirstActionButton, $[48] = t9) : t9 = $[48];
  let t10;
  return $[49] !== t5 || $[50] !== t6 || $[51] !== t7 || $[52] !== t8 || $[53] !== t9 ? (t10 = /* @__PURE__ */ jsxs(Flex, { align: "center", gap: 3, children: [
    t5,
    t6,
    t7,
    t8,
...
const FlipIcon = /* @__PURE__ */ styled(ChevronLeftIcon).withConfig({
...
const StackWrapper = /* @__PURE__ */ styled(Stack).withConfig({
  displayName: "StackWrapper",
  componentId: "sc-1ai615s-0"
})(["max-width:200px;"]), ListWrapper = /* @__PURE__ */ styled(Flex).withConfig({
  displayName: "ListWrapper",
  componentId: "sc-1ai615s-1"
})(["max-height:", ";min-width:244px;"], (props) => props.$maxHeight), Root$3 = /* @__PURE__ */ styled(Box).withConfig({
  displayName: "Root",
...
const Root$2 = /* @__PURE__ */ styled(Popover).withConfig({
  displayName: "Root",
...
function TimelineMenu(t0) {
  ...
  let t17;
  $[48] !== open || $[49] !== t12 || $[50] !== t13 || $[51] !== t14 || $[52] !== t16 ? (t17 = /* @__PURE__ */ jsx(Flex, { children: /* @__PURE__ */ jsx(Button$1, { "data-testid": t12, disabled: t13, mode: "ghost", onClick: t14, ref: setButton, selected: open, width: "fill", tooltipProps: null, justify: "space-between", style: t15, iconRight: ChevronDownIcon, text: t16 }) }), $[48] = open, $[49] = t12, $[50] = t13, $[51] = t14, $[52] = t16, $[53] = t17) : t17 = $[53];
  let t18;
...
const StyledMotionPath = /* @__PURE__ */ styled(motion.path).withConfig({
...
`, RotateGroup = /* @__PURE__ */ styled.g.withConfig({
  displayName: "RotateGroup",
  componentId: "sc-1l2ln4p-1"
})(["transform-origin:center;&[data-rotate]{animation:", " 1s ease-in-out infinite;}"], rotateAnimation), root = {
  syncing: {
    scale: 1,
    transition: {
      duration: 0
...
function DocumentStatusLine() {
  const $ = c(20), {
    ...
    documentId,
    documentType
  } = useDocumentPaneInfo(), [status, setStatus] = useState(null), eventsEnabled = useSource().beta?.eventsAPI?.documents;
  let t0;
  $[0] !== targetDocumentState ? (t0 = getTargetScopeId(targetDocumentState), $[0] = targetDocumentState, $[1] = t0) : t0 = $[1];
  ...
  let t2;
  $[5] !== lastUpdated || $[6] !== status || $[7] !== syncState.isSyncing ? (t2 = [status, lastUpdated, syncState.isSyncing], $[5] = lastUpdated, $[6] = status, $[7] = syncState.isSyncing, $[8] = t2) : t2 = $[8], useEffect(t1, t2);
  let t3;
  $[9] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t3 = () => {
    setStatus(null);
  }, $[9] = t3) : t3 = $[9];
  let t4;
  $[10] !== documentId ? (t4 = [documentId], $[10] = documentId, $[11] = t4) : t4 = $[11], useLayoutEffect(t3, t4);
  let t5;
  ...
  let t7;
  return $[17] !== eventsEnabled || $[18] !== status ? (t7 = /* @__PURE__ */ jsx(AnimatePresence, { children: status ? /* @__PURE__ */ jsx(MotionBox, { paddingLeft: 2, animate: {
    opacity: 1
  }, initial: {
    opacity: 0
  }, exit: {
    opacity: 0
  }, children: /* @__PURE__ */ jsx(DocumentStatusPulse, { status: status || void 0 }) }) : /* @__PURE__ */ jsx(Fragment, { children: eventsEnabled ? /* @__PURE__ */ jsx(EventsStatus, {}) : /* @__PURE__ */ jsx(TimelineStatus, {}) }) }), $[17] = eventsEnabled, $[18] = status, $[19] = t7) : t7 = $[19], t7;
}
...
const StatusText = /* @__PURE__ */ styled(Text).withConfig({
...
function StyledChangeConnectorRoot(props) {
  ...
  let t1;
  return $[5] !== restProps || $[6] !== t0 ? (t1 = /* @__PURE__ */ jsx(ChangeConnectorRoot, { ...restProps, className: t0 }), $[5] = restProps, $[6] = t0, $[7] = t1) : t1 = $[7], t1;
}
...
function DocumentPaneProvider(props) {
  ...
  const {
    ...
    data: t9
  } = useActiveReleases(), releases = t9 === void 0 ? EMPTY_ARRAY$2 : t9, diffViewRouter = useDiffViewRouter();
  let t10;
  ...
  const {
    ...
    inspectOpen,
    handleLegacyInspectClose
  } = useDocumentPaneInspector(t11), [isDeleting, setIsDeleting] = useState(!1), [isDocumentGroupInventoryActive, setIsDocumentGroupInventoryActive] = useState(!1), {
    lastRevisionDocument
  } = useDeletedDocumentLastRevision();
  let t12;
  ...
  let t17;
  $[41] !== params.path ? (t17 = params.path ? fromString(params.path) : EMPTY_ARRAY$2, $[41] = params.path, $[42] = t17) : t17 = $[42];
  ...
  const documentPaneInfo = t45, pathRef = useRef(void 0), paramPath = params.path;
  let t46;
  ...
  const syncPathFromUrl = useEffectEvent(t46);
  let t47;
  ...
  let t48;
  $[225] !== paramPath || $[226] !== ready ? (t48 = [paramPath, ready], $[225] = paramPath, $[226] = ready, $[227] = t48) : t48 = $[227], useEffect(t47, t48);
  ...
  $[228] !== editState_1 || $[229] !== formState || $[230] !== isDivergencesEnabled || $[231] !== schemaType || $[232] !== upstreamEditState_0 || $[233] !== value_0._id ? (t49 = isDivergencesEnabled && formState && schemaType ? {
    ...
    enabled: !1
  }, $[228] = editState_1, $[229] = formState, $[230] = isDivergencesEnabled, $[231] = schemaType, $[232] = upstreamEditState_0, $[233] = value_0._id, $[234] = t49) : t49 = $[234];
  const divergencesProps = t49;
  let t50;
  $[235] !== onProgrammaticFocus ? (t50 = /* @__PURE__ */ jsx(DivergenceAutofocus, { onProgrammaticFocus }), $[235] = onProgrammaticFocus, $[236] = t50) : t50 = $[236];
  let t51;
  $[237] !== displayed || $[238] !== isDeleted_1 || $[239] !== ready || $[240] !== schemaType ? (t51 = /* @__PURE__ */ jsx(DocumentTitle, { isDeleted: isDeleted_1, displayed, ready, schemaType }), $[237] = displayed, $[238] = isDeleted_1, $[239] = ready, $[240] = schemaType, $[241] = t51) : t51 = $[241];
  let t52;
  $[242] !== children ? (t52 = /* @__PURE__ */ jsx(ParseErrorsProvider, { children }), $[242] = children, $[243] = t52) : t52 = $[243];
  let t53;
  $[244] !== divergencesProps || $[245] !== t50 || $[246] !== t51 || $[247] !== t52 ? (t53 = /* @__PURE__ */ jsxs(DivergencesProvider, { ...divergencesProps, children: [
    t50,
    t51,
    t52
  ] }), $[244] = divergencesProps, $[245] = t50, $[246] = t51, $[247] = t52, $[248] = t53) : t53 = $[248];
  let t54;
  $[249] !== documentPane || $[250] !== t53 ? (t54 = /* @__PURE__ */ jsx(DocumentPaneContext.Provider, { value: documentPane, children: t53 }), $[249] = documentPane, $[250] = t53, $[251] = t54) : t54 = $[251];
  let t55;
  return $[252] !== documentPaneInfo || $[253] !== t54 ? (t55 = /* @__PURE__ */ jsx(DocumentPaneInfoContext.Provider, { value: documentPaneInfo, children: t54 }), $[252] = documentPaneInfo, $[253] = t54, $[254] = t55) : t55 = $[254], t55;
}
...
const DivergenceAutofocus = (t0) => {
  ...
  const $ = c(39), {
    params: t0
  } = usePaneRouter(), params = t0 === void 0 ? EMPTY_PARAMS$2 : t0, options = usePaneOptions(props.pane.options, params), liveEdit = !!useSchema().get(options.type)?.liveEdit, {
    selectedPerspectiveName,
    selectedPerspective,
    selectedVariantName
  } = usePerspective(), {
  ...
  }), showingPublishedOnDraft = liveEdit && selectedPerspective === "drafts" && !draftVersion, {
    rev,
    since
...
function DocumentPaneInner(props) {
  ...
  const childParams = t4, routerPanesStateLength = routerPanesState.length, {
    parentRefPath
  } = childParams;
  let t5;
  ...
  if (options.type === "*" && !isLoaded) {
    ...
    let t72;
    return $[22] !== paneKey || $[23] !== t62 ? (t72 = /* @__PURE__ */ jsx(LoadingPane, { flex: 2.5, minWidth: 320, paneKey, title: t62 }), $[22] = paneKey, $[23] = t62, $[24] = t72) : t72 = $[24], t72;
  }
  if (!documentType) {
    let t62;
    ...
    $[27] !== options.id ? (t72 = {
      id: options.id
    }, $[27] = options.id, $[28] = t72) : t72 = $[28];
    let t82;
    $[29] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t82 = {
      Code: _temp$f
    }, $[29] = t82) : t82 = $[29];
    let t92;
    $[30] !== t || $[31] !== t72 ? (t92 = /* @__PURE__ */ jsx(Stack, { space: 4, children: /* @__PURE__ */ jsx(Text, { as: "p", children: /* @__PURE__ */ jsx(Translate, { t, i18nKey: "panes.document-pane.document-not-found.text", values: t72, components: t82 }) }) }), $[30] = t, $[31] = t72, $[32] = t92) : t92 = $[32];
    let t102;
    return $[33] !== paneKey || $[34] !== t62 || $[35] !== t92 ? (t102 = /* @__PURE__ */ jsx(ErrorPane, { flex: 2.5, minWidth: 320, paneKey, title: t62, children: t92 }), $[33] = paneKey, $[34] = t62, $[35] = t92, $[36] = t102) : t102 = $[36], t102;
  }
  if (selectedVariantName && targetDocumentState.status === "resolving") {
    ...
    let t72;
    return $[39] !== paneKey || $[40] !== t62 ? (t72 = /* @__PURE__ */ jsx(LoadingPane, { flex: 2.5, minWidth: 320, paneKey, title: t62 }), $[39] = paneKey, $[40] = t62, $[41] = t72) : t72 = $[41], t72;
  }
  ...
  let t7;
  $[42] !== DocumentLayout2 || $[43] !== options.id || $[44] !== options.type ? (t7 = /* @__PURE__ */ jsx(DocumentLayout2, { documentId: options.id, documentType: options.type }), $[42] = DocumentLayout2, $[43] = options.id, $[44] = options.type, $[45] = t7) : t7 = $[45];
  let t8;
  $[46] !== options.id || $[47] !== options.type || $[48] !== t7 ? (t8 = /* @__PURE__ */ jsx(CommentsWrapper, { documentId: options.id, documentType: options.type, children: t7 }), $[46] = options.id, $[47] = options.type, $[48] = t7, $[49] = t8) : t8 = $[49];
  let t9;
  $[50] !== options.id || $[51] !== options.type || $[52] !== t8 ? (t9 = /* @__PURE__ */ jsx(DiffViewDocumentLayout, { documentId: options.id, documentType: options.type, children: t8 }), $[50] = options.id, $[51] = options.type, $[52] = t8, $[53] = t9) : t9 = $[53];
  let t10;
  $[54] !== ReferenceChildLink2 || $[55] !== activePath || $[56] !== handleEditReference || $[57] !== t9 || $[58] !== templatePermissions ? (t10 = /* @__PURE__ */ jsx(ReferenceInputOptionsProvider, { EditReferenceLinkComponent: ReferenceChildLink2, onEditReference: handleEditReference, initialValueTemplateItems: templatePermissions, activePath, children: t9 }), $[54] = ReferenceChildLink2, $[55] = activePath, $[56] = handleEditReference, $[57] = t9, $[58] = templatePermissions, $[59] = t10) : t10 = $[59];
  let t11;
  return $[60] !== providerProps || $[61] !== t10 || $[62] !== t6 ? (t11 = /* @__PURE__ */ jsx(DocumentPaneProviderWrapper, { ...providerProps, children: t10 }, t6), $[60] = providerProps, $[61] = t10, $[62] = t6, $[63] = t11) : t11 = $[63], t11;
}
function _temp$f(t0) {
  const {
    children
...
const ChevronWrapper = /* @__PURE__ */ styled(Box).withConfig({
  displayName: "ChevronWrapper",
  componentId: "sc-1ldyu0k-0"
})(["margin-left:auto;"]), CrossDatasetReferencesDetails = /* @__PURE__ */ styled.details.withConfig({
  displayName: "CrossDatasetReferencesDetails",
  componentId: "sc-1ldyu0k-1"
})(["flex:none;&[open] ", "{transform:rotate(180deg);}"], ChevronWrapper), CrossDatasetReferencesSummary = /* @__PURE__ */ styled.summary.withConfig({
  displayName: "CrossDatasetReferencesSummary",
  componentId: "sc-1ldyu0k-2"
})(["list-style:none;&::-webkit-details-marker{display:none;}"]), Table = /* @__PURE__ */ styled.table.withConfig({
  displayName: "Table",
  componentId: "sc-1ldyu0k-3"
})(["width:100%;text-align:left;padding:0 ", ";border-collapse:collapse;th{padding:", ";}td{padding:0 ", ";}tr > *:last-child{text-align:right;}"], ({
  theme
}) => rem(theme.sanity.space[2]), ({
  theme
}) => rem(theme.sanity.space[1]), ({
  theme
}) => rem(theme.sanity.space[1])), DocumentIdFlex = /* @__PURE__ */ styled(Flex).withConfig({
...
const DialogBody = /* @__PURE__ */ styled(Box).withConfig({
  displayName: "DialogBody",
  componentId: "sc-jawiy-0"
})(["box-sizing:border-box;"]), LoadingContainer = /* @__PURE__ */ styled(Flex).attrs({
  align: "center",
  direction: "column",
  justify: "center"
}).withConfig({
...
function ConfirmDeleteDialog(t0) {
  ...
  let t8;
  $[15] !== action || $[16] !== t ? (t8 = t("confirm-delete-dialog.header.text", {
    context: action
  }), $[15] = action, $[16] = t, $[17] = t8) : t8 = $[17];
  let t9;
...
const hashObject = (value) => {
  ...
  let t11;
  $[20] !== combinedInitialValueTemplates ? (t11 = /* @__PURE__ */ jsx(PaneHeaderCreateButton, { templateItems: combinedInitialValueTemplates }), $[20] = combinedInitialValueTemplates, $[21] = t11) : t11 = $[21];
  let t12;
  ...
  let t14;
  return $[27] !== t11 || $[28] !== t12 || $[29] !== t13 ? (t14 = /* @__PURE__ */ jsxs(Flex, { gap: 1, children: [
    t11,
    t12,
    t13
...
function getIncomingReferences({
  ...
  return (typeof filterQueryRaw == "function" ? documentPreviewStore.unstable_observeDocument(documentId).pipe(distinctUntilChanged((a, b) => a?._rev === b?._rev), switchMap$1((document2) => resolveRawFilterCallback(filterQueryRaw, {
    ...
    catchError((err) => (console.error(new Error("Failed to load incoming references", {
      cause: err
    })), of({
      documents: [],
      loading: !1
...
const INCOMING_REFERENCES_ITEM_HEIGHT = 51, INCOMING_REFERENCES_MAX_VISIBLE_ITEMS = 10, IncomingReferencesListContainer = /* @__PURE__ */ styled(Box).withConfig({
...
function getCrossDatasetIncomingReferences({
  ...
  return fetchCrossDatasetReferences(documentId, {
    versionedClient: client
  }).pipe(switchMap$1((referencesResult) => of(referencesResult).pipe(
    map((res) => res ? type?.dataset ? res.references.filter((ref) => ref.datasetName === type.dataset && ref.documentId) : res.references.filter((ref) => ref.documentId && ref.datasetName) : []),
    ...
    catchError((err) => (console.error(new Error("Failed to load cross-dataset incoming references", {
      cause: err
    })), of({
      documents: [],
      loading: !1
...
function IncomingReferencePreview(props) {
  ...
  let t4;
  $[7] !== documentPresence || $[8] !== documentPreviewStore || $[9] !== t3 || $[10] !== type || $[11] !== value ? (t4 = /* @__PURE__ */ jsx(PaneItemPreview, { documentPreviewStore, icon: t3, layout: "default", presence: documentPresence, schemaType: type, value }), $[7] = documentPresence, $[8] = documentPreviewStore, $[9] = t3, $[10] = type, $[11] = value, $[12] = t4) : t4 = $[12];
  let t5;
  return $[13] !== Link2 || $[14] !== t4 ? (t5 = /* @__PURE__ */ jsx(PreviewCard, { __unstable_focusRing: !0, as: Link2, "data-as": "a", radius: 2, children: t4 }), $[13] = Link2, $[14] = t4, $[15] = t5) : t5 = $[15], t5;
}
...
}, EMPTY_RECORD = {}, RootBox = /* @__PURE__ */ styled(Box).withConfig({
  displayName: "RootBox",
  componentId: "sc-1xocekz-0"
})(["position:relative;opacity:", ";transition:opacity 0.4s;"], (props) => props.$opacity || 1), CommandListBox = /* @__PURE__ */ styled(Box).withConfig({
...
`, AnimatedSpinnerIcon = /* @__PURE__ */ styled(SpinnerIcon).withConfig({
  displayName: "AnimatedSpinnerIcon",
  componentId: "sc-1nmsicq-0"
})(["animation:", " 500ms linear infinite;"], rotate), SubtleSpinnerIcon = /* @__PURE__ */ styled(SpinnerIcon).withConfig({
  displayName: "SubtleSpinnerIcon",
  componentId: "sc-1nmsicq-1"
})(["animation:", " 1500ms linear infinite;opacity:0.4;"], rotate), DelayedSubtleSpinnerIcon = /* @__PURE__ */ styled(SpinnerIcon).withConfig({
  displayName: "DelayedSubtleSpinnerIcon",
  componentId: "sc-1nmsicq-2"
})(["animation:", " 1500ms linear infinite,", " 1000ms linear;opacity:0.4;"], rotate, fadeIn), DocumentListPane = memo(function(props) {
  const $ = c(96), {
    childItemId,
    isActive,
    pane,
...
const addIdsToMenuItems = (menuItems) => menuItems?.map((item) => item.id ? item : {
  ...
  return [...menuItems, ...hasSortItems ? [restoreDefaultSortOrderItem] : [], ...hasLayoutItems ? [restoreDefaultLayoutItem] : []];
};
...
const PaneContainer = memo(function(props) {
  ...
  let t18;
  $[44] !== pane.source ? (t18 = _DEBUG, $[44] = pane.source, $[45] = t18) : t18 = $[45];
  let t19;
  $[46] !== customMenuItemState || $[47] !== handleRestoreDefaultLayout || $[48] !== handleRestoreDefaultSortOrder || $[49] !== handleSetSortOrder || $[50] !== index || $[51] !== initialValueTemplates || $[52] !== menuItemGroups || $[53] !== menuItemsWithRestoreDefaults || $[54] !== setLayout || $[55] !== title ? (t19 = /* @__PURE__ */ jsx(PaneHeader, { customMenuItemState, index, initialValueTemplates, menuItemGroups, menuItems: menuItemsWithRestoreDefaults, setLayout, setSortOrder: handleSetSortOrder, setCustomMenuItemState, restoreDefaultLayout: handleRestoreDefaultLayout, restoreDefaultSortOrder: handleRestoreDefaultSortOrder, title }), $[46] = customMenuItemState, $[47] = handleRestoreDefaultLayout, $[48] = handleRestoreDefaultSortOrder, $[49] = handleSetSortOrder, $[50] = index, $[51] = initialValueTemplates, $[52] = menuItemGroups, $[53] = menuItemsWithRestoreDefaults, $[54] = setLayout, $[55] = title, $[56] = t19) : t19 = $[56];
  let t20;
  $[57] !== layout || $[58] !== props || $[59] !== validatedSortOrder ? (t20 = /* @__PURE__ */ jsx(DocumentListPane, { ...props, sortOrder: validatedSortOrder, layout }), $[57] = layout, $[58] = props, $[59] = validatedSortOrder, $[60] = t20) : t20 = $[60];
  let t21;
  $[61] !== isSelected || $[62] !== paneKey || $[63] !== t18 || $[64] !== t19 || $[65] !== t20 ? (t21 = /* @__PURE__ */ jsxs(Pane, { "data-ui": "DocumentListPane", id: paneKey, minWidth: 320, currentMaxWidth: 350, maxWidth: 640, selected: isSelected, children: [
    t18,
    t19,
    t20
  ] }), $[61] = isSelected, $[62] = paneKey, $[63] = t18, $[64] = t19, $[65] = t20, $[66] = t21) : t21 = $[66];
  let t22;
  return $[67] !== t17 || $[68] !== t21 ? (t22 = /* @__PURE__ */ jsx(SourceProvider, { name: t17, children: t21 }), $[67] = t17, $[68] = t21, $[69] = t22) : t22 = $[69], t22;
});
...
const Scroller$3 = /* @__PURE__ */ styled(ScrollContainer).withConfig({
  displayName: "Scroller",
  componentId: "sc-jiqgdv-0"
})(["height:100%;overflow:auto;position:relative;scroll-behavior:smooth;"]), Grid$1 = /* @__PURE__ */ styled(Box).withConfig({
  displayName: "Grid",
...
const Root = /* @__PURE__ */ styled(Popover).withConfig({
  displayName: "Root",
...
const Scroller$2 = /* @__PURE__ */ styled(ScrollContainer).withConfig({
  displayName: "Scroller",
  componentId: "sc-qjtu5v-0"
})(["height:100%;overflow:auto;position:relative;scroll-behavior:smooth;"]), Grid = /* @__PURE__ */ styled(Box).withConfig({
  displayName: "Grid",
  componentId: "sc-qjtu5v-1"
})(["&:not([hidden]){display:grid;}grid-template-columns:48px 1fr;align-items:center;gap:0.25em;"]), SpinnerContainer = /* @__PURE__ */ styled(Flex).withConfig({
  ...
  const $ = c(31), {
    ...
    t
  } = useTranslation(structureLocaleNamespace), isVariantTarget = targetDocumentState.status === "ready" && targetDocumentState.variant !== void 0, siblingScopeId = isVariantTarget ? targetDocumentState.publishedSibling?._system.scopeId : void 0, siblingEditState = useEditState(documentId, documentType, "default", siblingScopeId), publishedComparisonBase = isVariantTarget ? siblingScopeId && siblingEditState.version || null : editState?.published;
  let t0;
  $[0] !== displayed || $[1] !== publishedComparisonBase ? (t0 = diffInput(wrap(publishedComparisonBase ?? {}, {
    author: ""
  }), wrap(displayed ?? {}, {
    author: ""
  })), $[0] = displayed, $[1] = publishedComparisonBase, $[2] = t0) : t0 = $[2];
  const rootDiff = t0;
  if (isVariantTarget && !publishedComparisonBase || selectedReleaseId && !editState?.version || selectedPerspective === "drafts" && !editState?.draft || selectedPerspectiveName === "published" || !displayed?._rev)
    return null;
  let t1;
...
const Scroller$1 = /* @__PURE__ */ styled(ScrollContainer).withConfig({
  displayName: "Scroller",
...
const Scroller = /* @__PURE__ */ styled(ScrollContainer).withConfig({
  displayName: "Scroller",
...
const FadeInFlex$1 = /* @__PURE__ */ styled(Flex).withConfig({
