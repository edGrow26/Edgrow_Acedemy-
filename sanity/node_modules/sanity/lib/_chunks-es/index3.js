...
import { useCommentsEnabled, CommentsEnabledProvider, CommentsSelectedPathProvider, CommentsAuthoringPathProvider } from "./index2.js";
import "react";
...
function CommentsDocumentLayout(props) {
  ...
  if (useCommentsEnabled().mode !== null) {
    let t02;
    return $[0] !== props ? (t02 = /* @__PURE__ */ jsx(CommentsDocumentLayoutInner, { ...props }), $[0] = props, $[1] = t02) : t02 = $[1], t02;
  }
  let t0;
  $[2] !== props ? (t0 = /* @__PURE__ */ jsx(CommentsDocumentLayoutInner, { ...props }), $[2] = props, $[3] = t0) : t0 = $[3];
  let t1;
...
function CommentsDocumentLayoutInner(props) {
  ...
  let t1;
  return $[4] !== t0 ? (t1 = /* @__PURE__ */ jsx(CommentsSelectedPathProvider, { children: /* @__PURE__ */ jsx(CommentsAuthoringPathProvider, { children: t0 }) }), $[4] = t0, $[5] = t1) : t1 = $[5], t1;
}
export {
  CommentsDocumentLayout
};
