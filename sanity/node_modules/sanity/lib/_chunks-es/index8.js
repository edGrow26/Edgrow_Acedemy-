...
const CommentsPortableTextInputInner = memo(function(props) {
  ...
  const handleDecoratorClick = t10, blurred = useRef(!1);
  let t11;
  ...
  $[37] !== addedCommentsDecorations || $[38] !== getComment || $[39] !== operation || $[40] !== props.path ? (t15 = () => {
    ...
    decoratorsToUpdate.length !== 0 && (decoratorsToUpdate.forEach((decorator_0) => {
      ...
      if (!comment_0 || !editorRef.current)
        return;
      const editorValue = PortableTextEditor.getValue(editorRef.current) || EMPTY_ARRAY, [updatedDecoration] = buildRangeDecorationSelectionsFromComments({
        ...
        documentValue: documentValueRef.current,
        basePath: props.path
      }), nextRange = updatedDecoration?.range ? [updatedDecoration.range] : EMPTY_ARRAY, nextValue_0 = updatedDecoration ? [...comment_0.target.path?.selection?.value.filter((r) => r._key !== nextRange[0]?._key).concat(nextRange).flat().sort(_temp4) || EMPTY_ARRAY] : EMPTY_ARRAY, nextComment = {
        target: {
          ...comment_0.target,
          path: {
  ...
  let t20;
  $[53] !== addedCommentsDecorations || $[54] !== authoringDecoration || $[55] !== t19 ? (t20 = [...t19, ...authoringDecoration ? [authoringDecoration] : EMPTY_ARRAY, ...addedCommentsDecorations], $[53] = addedCommentsDecorations, $[54] = authoringDecoration, $[55] = t19, $[56] = t20) : t20 = $[56];
  const rangeDecorations = t20, [currentSelectionIsOverlapping, setCurrentSelectionIsOverlapping] = useState(!1);
  let t21, t22;
  ...
  }, t22 = [addedCommentsDecorations, currentSelection], $[57] = addedCommentsDecorations, $[58] = currentSelection, $[59] = t21, $[60] = t22) : (t21 = $[59], t22 = $[60]), useEffect(t21, t22);
  ...
  bb1: {
    ...
    let t262;
    $[64] !== currentSelectionRect ? (t262 = {
      getBoundingClientRect: () => currentSelectionRect
    }, $[64] = currentSelectionRect, $[65] = t262) : t262 = $[65], t25 = t262;
  }
  ...
  }, t27 = [currentSelection, scrollElement, handleSetCurrentSelectionRect], $[66] = currentSelection, $[67] = scrollElement, $[68] = t26, $[69] = t27) : (t26 = $[68], t27 = $[69]), useEffect(t26, t27);
  let t28, t29;
  ...
  }, t29 = [handleBuildRangeDecorations, textComments], $[70] = handleBuildRangeDecorations, $[71] = textComments, $[72] = t28, $[73] = t29) : (t28 = $[72], t29 = $[73]), useEffect(t28, t29);
  ...
  let t30;
  $[74] !== currentUser || $[75] !== handleSubmit || $[76] !== mentionOptions || $[77] !== nextCommentValue || $[78] !== popoverAuthoringReferenceElement || $[79] !== showFloatingInput ? (t30 = showFloatingInput && currentUser && /* @__PURE__ */ jsx(InlineCommentInputPopover, { currentUser, mentionOptions, onChange: setNextCommentValue, onClickOutside: resetStates, onDiscardConfirm: handleCommentDiscardConfirm, onSubmit: handleSubmit, referenceElement: popoverAuthoringReferenceElement, value: nextCommentValue }), $[74] = currentUser, $[75] = handleSubmit, $[76] = mentionOptions, $[77] = nextCommentValue, $[78] = popoverAuthoringReferenceElement, $[79] = showFloatingInput, $[80] = t30) : t30 = $[80];
  let t31;
  $[81] !== addonDatasetError || $[82] !== currentSelectionIsOverlapping || $[83] !== handleSelectCurrentSelection || $[84] !== selectionReferenceElement || $[85] !== showFloatingButton || $[86] !== showFloatingInput ? (t31 = showFloatingButton && !showFloatingInput && /* @__PURE__ */ jsx(FloatingButtonPopover, { disabled: currentSelectionIsOverlapping || !!addonDatasetError, onClick: handleSelectCurrentSelection, onClickOutside: resetStates, referenceElement: selectionReferenceElement }), $[81] = addonDatasetError, $[82] = currentSelectionIsOverlapping, $[83] = handleSelectCurrentSelection, $[84] = selectionReferenceElement, $[85] = showFloatingButton, $[86] = showFloatingInput, $[87] = t31) : t31 = $[87];
  let t32;
  $[88] !== t31 ? (t32 = /* @__PURE__ */ jsx(AnimatePresence, { children: t31 }), $[88] = t31, $[89] = t32) : t32 = $[89];
  let t33;
  $[90] !== boundaryElement || $[91] !== t30 || $[92] !== t32 ? (t33 = /* @__PURE__ */ jsxs(BoundaryElementProvider, { element: boundaryElement, children: [
    t30,
    t32
  ] }), $[90] = boundaryElement, $[91] = t30, $[92] = t32, $[93] = t33) : t33 = $[93];
  let t34;
  $[94] !== onEditorChange || $[95] !== props || $[96] !== rangeDecorations ? (t34 = /* @__PURE__ */ jsx(Stack, { ref: setRootElement, onMouseDown: handleMouseDown, onMouseUp: handleMouseUp, children: /* @__PURE__ */ jsx(RenderDefaultCommentsPortableTextInputInner, { ...props, onEditorChange, editorRef, rangeDecorations, onFullScreenChange: setIsFullScreen }) }), $[94] = onEditorChange, $[95] = props, $[96] = rangeDecorations, $[97] = t34) : t34 = $[97];
  let t35;
  return $[98] !== t33 || $[99] !== t34 ? (t35 = /* @__PURE__ */ jsxs(Fragment, { children: [
    t33,
    t34
  ] }), $[98] = t33, $[99] = t34, $[100] = t35) : t35 = $[100], t35;
});
