...
import { VARIANTS_STUDIO_CLIENT_OPTIONS, RELEASES_STUDIO_CLIENT_OPTIONS, isReleasePerspective, useClient } from "sanity";
...
const PostMessageDocuments = (props) => {
  ...
  let t0;
  $[0] !== perspective || $[1] !== variant ? (t0 = variant ? VARIANTS_STUDIO_CLIENT_OPTIONS : isReleasePerspective(perspective) ? RELEASES_STUDIO_CLIENT_OPTIONS : {
    apiVersion: API_VERSION
  }, $[0] = perspective, $[1] = variant, $[2] = t0) : t0 = $[2];
  ...
  let t3, t4;
  $[7] !== client || $[8] !== comlink ? (t3 = () => comlink.on("visual-editing/fetch-snapshot", async (data) => ({
    snapshot: await client.getDocument(data.documentId, {
      tag: "document.snapshots"
    })
  })), t4 = [client, comlink], $[7] = client, $[8] = comlink, $[9] = t3, $[10] = t4) : (t3 = $[9], t4 = $[10]), useEffect(t3, t4);
  let t5, t6;
