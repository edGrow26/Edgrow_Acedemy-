...
import { presentationLocaleNamespace, usePresentationTool, PresentationSpinner, API_VERSION, MAX_TIME_TO_OVERLAYS_CONNECTION, usePresentationNavigate, POPUP_CHECK_INTERVAL, DEFAULT_TOOL_NAME, NARROW_MEDIA_INDEX, EDIT_INTENT_MODE } from "./presentation.js";
...
import { urlSearchParamPreviewPerspective, urlSearchParamPreviewVariant, fetchSharedAccessQuery, urlSearchParamVercelProtectionBypass, urlSearchParamVercelSetBypassCookie, urlSearchParamPreviewSecret, urlSearchParamPreviewPathname, schemaTypeSingleton, schemaIdSingleton, schemaType } from "@sanity/preview-url-secret/constants";
import { Card, Flex, TabList, Text, Stack, Inline, Box, Container as Container$1, Label, Code, TextInput, Spinner, useToast, Grid, Switch, MenuDivider, Menu, Hotkeys, usePrefersReducedMotion, useMediaIndex, BoundaryElementProvider } from "@sanity/ui";
...
import { useTranslation, getPublishedId, pathToString, useUnique, useDocumentPreviewStore, usePerspective, getPreviewStateObservable, useSchema, getPreviewValueWithFallback, SanityDefaultPreview, PreviewCard, Translate, CommentsIntentProvider, useActiveWorkspace, useClient, useCurrentUser, VARIANTS_STUDIO_CLIENT_OPTIONS, useProjectId, useDataset, useWorkspace, COMMENTS_INSPECTOR_NAME, useGrantsStore } from "sanity";
...
import { PaneRouterContext, StructureToolProvider, PaneLayout, ORDER_BY_IDS_PARAM_FIELD, DocumentListPane as DocumentListPane$1, DocumentPane as DocumentPane$1 } from "sanity/structure";
...
}, Root$1 = /* @__PURE__ */ styled.div.withConfig({
  displayName: "Root",
...
const PanelsWrapper = /* @__PURE__ */ styled.div.withConfig({
...
const RootLayout = /* @__PURE__ */ styled(PaneLayout).withConfig({
  displayName: "RootLayout",
  componentId: "sc-18wb5dr-0"
})(["height:100%;"]), Root = /* @__PURE__ */ styled(Flex).withConfig({
  displayName: "Root",
  componentId: "sc-18wb5dr-1"
})(["& > div{min-width:none !important;max-width:none !important;}"]), WrappedCode$1 = /* @__PURE__ */ styled(Code).withConfig({
...
const WrappedCode = /* @__PURE__ */ styled(Code).withConfig({
  displayName: "WrappedCode",
...
const Resizer = /* @__PURE__ */ styled.div.withConfig({
  displayName: "Resizer",
  componentId: "sc-1ov4oxw-0"
})(["position:relative;", ""], ({
  $hidden
}) => $hidden && "display: none;"), ResizerInner = /* @__PURE__ */ styled.div.withConfig({
  displayName: "ResizerInner",
  componentId: "sc-1ov4oxw-1"
})(["position:absolute;top:0;bottom:0;left:-5px;width:9px;z-index:10;cursor:", ";& > span:nth-child(1){display:block;border-left:1px solid var(--card-border-color);position:absolute;top:0;left:4px;bottom:0;transition:opacity 200ms;}", ""], ({
  $disabled
...
})(["box-shadow:0 0 0 1px var(--card-border-color);border:0;max-height:100%;width:100%;view-transition-class:presentation-tool-iframe;"])), IFrameOverlay = /* @__PURE__ */ styled(Box).withConfig({
...
function OpenPreviewButton(props) {
  ...
  let t0;
  $[6] !== openPopup ? (t0 = (event) => {
    event.preventDefault(), openPopup(event.currentTarget.href);
  }, $[6] = openPopup, $[7] = t0) : t0 = $[7];
  const handleOpenPopup = t0;
  let t1;
  $[8] !== t ? (t1 = t("share-url.menu-item.open.text"), $[8] = t, $[9] = t1) : t1 = $[9];
  let t2;
  $[10] !== t1 ? (t2 = /* @__PURE__ */ jsx(Text, { size: 1, children: t1 }), $[10] = t1, $[11] = t2) : t2 = $[11];
  let t3;
  $[12] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t3 = ["bottom-start"], $[12] = t3) : t3 = $[12];
  let t4;
  $[13] !== t ? (t4 = t("share-url.menu-item.open.text"), $[13] = t, $[14] = t4) : t4 = $[14];
  let t5;
  $[15] !== handleOpenPopup || $[16] !== openPreviewLink || $[17] !== t4 ? (t5 = /* @__PURE__ */ jsx(Button, { as: "a", "aria-label": t4, icon: LaunchIcon, mode: "bleed", href: openPreviewLink, rel: "opener", target: "_blank", tooltipProps: null, onClick: handleOpenPopup }), $[15] = handleOpenPopup, $[16] = openPreviewLink, $[17] = t4, $[18] = t5) : t5 = $[18];
  let t6;
  return $[19] !== t2 || $[20] !== t5 ? (t6 = /* @__PURE__ */ jsx(Tooltip, { animate: !0, content: t2, fallbackPlacements: t3, placement: "bottom", portal: !0, children: t5 }), $[19] = t2, $[20] = t5, $[21] = t6) : t6 = $[21], t6;
}
...
const QRCodeSVG = lazy(() => import("./QRCodeSVG.js")), QrCodeLogoSize = 24, QrCodeLogoPadding = 16, QrSize = 224, StyledSanityMonogram = /* @__PURE__ */ styled(SanityMonogram).withConfig({
  displayName: "StyledSanityMonogram",
  componentId: "sc-wa94k4-0"
})(["position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);height:", "px;width:", "px;"], QrCodeLogoSize, QrCodeLogoSize), MotionSpinner = motion.create(Spinner), MotionText = motion.create(Text), MotionMonogram = motion.create(StyledSanityMonogram);
function SharePreviewMenu(props) {
  ...
  }, t7 = [client], $[20] = client, $[21] = t6, $[22] = t7) : (t6 = $[21], t7 = $[22]), useEffect(t6, t7);
  let t8;
  $[23] !== t ? (t8 = t("preview-frame.share-button.aria-label"), $[23] = t, $[24] = t8) : t8 = $[24];
  let t9;
  $[25] !== t8 ? (t9 = /* @__PURE__ */ jsx(Button, { "aria-label": t8, icon: ShareIcon, mode: "bleed", tooltipProps: null }), $[25] = t8, $[26] = t9) : t9 = $[26];
  let t10;
  ...
  let t12;
  $[28] !== busy || $[29] !== canToggleSharePreviewAccess || $[30] !== canUseSharedPreviewAccess || $[31] !== disabling || $[32] !== enabling || $[33] !== handleCopyUrl || $[34] !== handleDisableSharing || $[35] !== handleEnableSharing || $[36] !== handleUnableToToggle || $[37] !== loading || $[38] !== t || $[39] !== url ? (t12 = canUseSharedPreviewAccess ? /* @__PURE__ */ jsxs(Fragment, { children: [
  ...
  let t13;
  $[41] !== t11 || $[42] !== t12 ? (t13 = /* @__PURE__ */ jsx(Menu, { style: t10, padding: t11, children: t12 }), $[41] = t11, $[42] = t12, $[43] = t13) : t13 = $[43];
  let t14;
  $[44] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t14 = {
    constrainSize: !0,
    placement: "bottom",
    portal: !0
  }, $[44] = t14) : t14 = $[44];
  let t15;
  return $[45] !== t13 || $[46] !== t9 ? (t15 = /* @__PURE__ */ jsx(MenuButton, { button: t9, id: "share-menu", menu: t13, popover: t14 }), $[45] = t13, $[46] = t9, $[47] = t15) : t15 = $[47], t15;
}
const PreviewHeaderDefault = (props) => {
  ...
  let t31;
  $[66] !== openPopup || $[67] !== perspective || $[68] !== previewLocationOrigin || $[69] !== previewLocationRoute || $[70] !== targetOrigin || $[71] !== variant ? (t31 = /* @__PURE__ */ jsx(Box, { padding: 1, children: /* @__PURE__ */ jsx(OpenPreviewButton, { openPopup, previewLocationOrigin, previewLocationRoute, perspective, variant, targetOrigin }) }), $[66] = openPopup, $[67] = perspective, $[68] = previewLocationOrigin, $[69] = previewLocationRoute, $[70] = targetOrigin, $[71] = variant, $[72] = t31) : t31 = $[72];
  let t32;
  $[73] !== onPathChange || $[74] !== previewLocationRoute || $[75] !== previewUrlRef || $[76] !== t30 || $[77] !== t31 ? (t32 = /* @__PURE__ */ jsx(Box, { flex: 1, children: /* @__PURE__ */ jsx(PreviewLocationInput, { previewUrlRef, prefix: t30, onChange: onPathChange, suffix: t31, value: previewLocationRoute }) }), $[73] = onPathChange, $[74] = previewLocationRoute, $[75] = previewUrlRef, $[76] = t30, $[77] = t31, $[78] = t32) : t32 = $[78];
  let t33;
  $[79] !== perspectiveToggleTooltipId ? (t33 = (node) => {
    node?.style.setProperty("view-transition-name", perspectiveToggleTooltipId);
  }, $[79] = perspectiveToggleTooltipId, $[80] = t33) : t33 = $[80];
  const t34 = viewport === "desktop" ? "narrow" : "full";
  let t35;
  $[81] !== t || $[82] !== t34 ? (t35 = t("preview-frame.viewport-button.tooltip", {
    context: t34
  }), $[81] = t, $[82] = t34, $[83] = t35) : t35 = $[83];
  let t36;
  $[84] !== t35 ? (t36 = /* @__PURE__ */ jsx(Text, { size: 1, children: t35 }), $[84] = t35, $[85] = t36) : t36 = $[85];
  let t37;
  $[86] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t37 = ["bottom-start"], $[86] = t37) : t37 = $[86];
  let t38;
  $[87] !== t ? (t38 = t("preview-frame.viewport-button.aria-label"), $[87] = t, $[88] = t38) : t38 = $[88];
  const t39 = viewport === "desktop" ? MobileDeviceIcon : DesktopIcon;
  let t40;
  $[89] !== t38 || $[90] !== t39 || $[91] !== toggleViewportSize || $[92] !== viewport ? (t40 = /* @__PURE__ */ jsx(Button, { "data-testid": "preview-viewport-toggle", "data-viewport": viewport, "aria-label": t38, icon: t39, mode: "bleed", onClick: toggleViewportSize, tooltipProps: null }), $[89] = t38, $[90] = t39, $[91] = toggleViewportSize, $[92] = viewport, $[93] = t40) : t40 = $[93];
  let t41;
  $[94] !== t33 || $[95] !== t36 || $[96] !== t40 ? (t41 = /* @__PURE__ */ jsx(Flex, { align: "center", flex: "none", gap: 1, children: /* @__PURE__ */ jsx(Tooltip, { animate: !0, ref: t33, content: t36, fallbackPlacements: t37, placement: "bottom", portal: !0, children: t40 }) }), $[94] = t33, $[95] = t36, $[96] = t40, $[97] = t41) : t41 = $[97];
  let t42;
  $[98] !== canSharePreviewAccess || $[99] !== canToggleSharePreviewAccess || $[100] !== canUseSharedPreviewAccess || $[101] !== initialUrl || $[102] !== perspective || $[103] !== previewLocationRoute || $[104] !== variant ? (t42 = canSharePreviewAccess && /* @__PURE__ */ jsx(Flex, { align: "center", flex: "none", gap: 1, children: /* @__PURE__ */ jsx(SharePreviewMenu, { canToggleSharePreviewAccess, canUseSharedPreviewAccess, previewLocationRoute, initialUrl, perspective, variant }) }), $[98] = canSharePreviewAccess, $[99] = canToggleSharePreviewAccess, $[100] = canUseSharedPreviewAccess, $[101] = initialUrl, $[102] = perspective, $[103] = previewLocationRoute, $[104] = variant, $[105] = t42) : t42 = $[105];
  let t43;
  return $[106] !== t23 || $[107] !== t32 || $[108] !== t4 || $[109] !== t41 || $[110] !== t42 ? (t43 = /* @__PURE__ */ jsxs(Flex, { align: "center", gap: 1, paddingX: 1, style: t3, children: [
    t4,
    t23,
    t32,
    t41,
...
const MotionFlex = motion.create(Flex), Preview = memo(forwardRef(function(props, forwardedRef) {
  ...
  } = props, [stablePerspective, setStablePerspective] = useState(null), urlPerspective = encodeStudioPerspective(stablePerspective === null ? perspective : stablePerspective), [stableVariant, setStableVariant] = useState(null), urlVariant = stableVariant === null ? variant : stableVariant, previewUrl = useMemo(() => {
...
function useMainDocument(props) {
  ...
  let t2;
  $[2] !== variant ? (t2 = variant ? VARIANTS_STUDIO_CLIENT_OPTIONS : {
    apiVersion: API_VERSION
  }, $[2] = variant, $[3] = t2) : t2 = $[3];
  ...
  let t6;
  return $[18] !== client || $[19] !== perspective || $[20] !== relativeUrl || $[21] !== resolvers || $[22] !== targetOrigin || $[23] !== variant ? (t6 = [client, perspective, relativeUrl, resolvers, targetOrigin, variant], $[18] = client, $[19] = perspective, $[20] = relativeUrl, $[21] = resolvers, $[22] = targetOrigin, $[23] = variant, $[24] = t6) : t6 = $[24], useEffect(t5, t6), mainDocumentState;
}
function _temp$8(t0) {
  const [key] = t0;
  return key === "preview";
...
function usePresentationVariant() {
  const {
    selectedVariantName
  } = usePerspective();
...
function PresentationTool(props) {
  ...
  const mainDocumentState = useMainDocument(t7), [overlaysConnection, setOverlaysConnection] = useStatus(), [loadersConnection, setLoadersConnection] = useStatus(), [previewKitConnection, setPreviewKitConnection] = useStatus(), [_handlesPerspectiveChange, setHandlesPerspectiveChange] = useState(!1), handlesPerspectiveChange = _handlesPerspectiveChange || loadersConnection === "connected", [_handlesVariantChange, setHandlesVariantChange] = useState(!1), handlesVariantChange = _handlesVariantChange || loadersConnection === "connected", {
  ...
  let t10;
  $[26] !== navigate ? (t10 = (options) => {
    navigate(options);
  }, $[26] = navigate, $[27] = t10) : t10 = $[27];
  ...
  let t12;
  $[35] !== controller || $[36] !== presentationRef || $[37] !== setDocumentsOnPage || $[38] !== setOverlaysConnection || $[39] !== targetOrigin ? (t12 = [controller, presentationRef, setDocumentsOnPage, setOverlaysConnection, targetOrigin], $[35] = controller, $[36] = presentationRef, $[37] = setDocumentsOnPage, $[38] = setOverlaysConnection, $[39] = targetOrigin, $[40] = t12) : t12 = $[40], useEffect(t11, t12);
  let t13;
  ...
  let t14;
  $[47] !== controller || $[48] !== dataset || $[49] !== projectId || $[50] !== setDocumentsOnPage || $[51] !== setPreviewKitConnection || $[52] !== targetOrigin ? (t14 = [controller, dataset, projectId, setDocumentsOnPage, setPreviewKitConnection, targetOrigin], $[47] = controller, $[48] = dataset, $[49] = projectId, $[50] = setDocumentsOnPage, $[51] = setPreviewKitConnection, $[52] = targetOrigin, $[53] = t14) : t14 = $[53], useEffect(t13, t14);
  let t15;
  $[54] !== isSameDocument || $[55] !== navigate ? (t15 = debounce((state_1) => {
  ...
  let t17;
  $[62] !== navigate ? (t17 = (params_0) => {
    navigate({
      params: params_0
    });
  }, $[62] = navigate, $[63] = t17) : t17 = $[63];
  const handleStructureParams = t17;
  let t18;
  $[64] !== navigate ? (t18 = (options_0) => {
    navigate(options_0);
  }, $[64] = navigate, $[65] = t18) : t18 = $[65];
  ...
  }, t20 = [params.id, params.path, visualEditingComlink], $[66] = params.id, $[67] = params.path, $[68] = visualEditingComlink, $[69] = t19, $[70] = t20) : (t19 = $[69], t20 = $[70]), useEffect(t19, t20);
  let t21, t22;
  ...
  }, t22 = [overlaysConnection, targetOrigin, params.preview, visualEditingComlink], $[71] = overlaysConnection, $[72] = params.preview, $[73] = targetOrigin, $[74] = visualEditingComlink, $[75] = t21, $[76] = t22) : (t21 = $[75], t22 = $[76]), useEffect(t21, t22);
  let t23;
  $[77] !== visualEditingComlink ? (t23 = () => visualEditingComlink?.post("presentation/toggle-overlay"), $[77] = visualEditingComlink, $[78] = t23) : t23 = $[78];
  const toggleOverlay = t23, [displayedDocument, setDisplayedDocument] = useState(null);
  let t24, t25;
  $[79] !== toggleOverlay ? (t24 = () => {
    const handleKeyUp = (e) => {
  ...
  }, t25 = [toggleOverlay], $[79] = toggleOverlay, $[80] = t24, $[81] = t25) : (t24 = $[80], t25 = $[81]), useEffect(t24, t25);
  const [boundaryElement, setBoundaryElement] = useState(null);
  let t26;
  $[82] !== unstable_navigator ? (t26 = {
    unstable_navigator
  }, $[82] = unstable_navigator, $[83] = t26) : t26 = $[83];
  ...
  let t30;
  $[92] !== params.preview || $[93] !== workspace.name ? (t30 = (t312) => {
    const {
      id,
      type,
      path
  ...
  }, $[95] = navigate, $[96] = t31) : t31 = $[96];
  const setViewport = t31;
  let t32;
  $[97] !== isNarrow || $[98] !== navigatorEnabled || $[99] !== resolvedTab ? (t32 = isNarrow && /* @__PURE__ */ jsx(PresentationNarrowTabBar, { activeTab: resolvedTab, navigatorEnabled, onTabChange: setActiveTab }), $[97] = isNarrow, $[98] = navigatorEnabled, $[99] = resolvedTab, $[100] = t32) : t32 = $[100];
  let t33;
  $[101] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t33 = {
    minHeight: 0
  }, $[101] = t33) : t33 = $[101];
  const t34 = isNarrow && resolvedTab !== "navigator";
  let t35;
  $[102] !== PresentationNavigator || $[103] !== isNarrow || $[104] !== t34 ? (t35 = /* @__PURE__ */ jsx(PresentationNavigator, { hidden: t34, resizerHidden: isNarrow }), $[102] = PresentationNavigator, $[103] = isNarrow, $[104] = t34, $[105] = t35) : t35 = $[105];
  let t36;
  $[106] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t36 = getPresentationPanelHtmlId("preview"), $[106] = t36) : t36 = $[106];
  const t37 = navigatorEnabled ? 50 : 75, t38 = isNarrow && resolvedTab !== "preview";
  let t39;
  $[107] !== canSharePreviewAccess || $[108] !== canToggleSharePreviewAccess || $[109] !== canUseSharedPreviewAccess || $[110] !== handleOpenPopup || $[111] !== handlePreviewPath || $[112] !== handleRefresh || $[113] !== handlesPerspectiveChange || $[114] !== handlesVariantChange || $[115] !== initialPreviewUrl || $[116] !== loadersConnection || $[117] !== navigatorEnabled || $[118] !== overlaysConnection || $[119] !== params.preview || $[120] !== perspective || $[121] !== presentationRef || $[122] !== previewUrlRef || $[123] !== setViewport || $[124] !== targetOrigin || $[125] !== toggleNavigator || $[126] !== toggleOverlay || $[127] !== unstable_header || $[128] !== variant || $[129] !== vercelProtectionBypass || $[130] !== viewport ? (t39 = /* @__PURE__ */ jsx(Preview, { canSharePreviewAccess, canToggleSharePreviewAccess, canUseSharedPreviewAccess, header: unstable_header, initialUrl: initialPreviewUrl, loadersConnection, navigatorEnabled, onPathChange: handlePreviewPath, onRefresh: handleRefresh, openPopup: handleOpenPopup, overlaysConnection, previewUrl: params.preview, perspective, variant, ref: iframeRef, setViewport, targetOrigin, toggleNavigator, toggleOverlay, viewport, vercelProtectionBypass, presentationRef, previewUrlRef, handlesPerspectiveChange, handlesVariantChange }, targetOrigin), $[107] = canSharePreviewAccess, $[108] = canToggleSharePreviewAccess, $[109] = canUseSharedPreviewAccess, $[110] = handleOpenPopup, $[111] = handlePreviewPath, $[112] = handleRefresh, $[113] = handlesPerspectiveChange, $[114] = handlesVariantChange, $[115] = initialPreviewUrl, $[116] = loadersConnection, $[117] = navigatorEnabled, $[118] = overlaysConnection, $[119] = params.preview, $[120] = perspective, $[121] = presentationRef, $[122] = previewUrlRef, $[123] = setViewport, $[124] = targetOrigin, $[125] = toggleNavigator, $[126] = toggleOverlay, $[127] = unstable_header, $[128] = variant, $[129] = vercelProtectionBypass, $[130] = viewport, $[131] = t39) : t39 = $[131];
  let t40;
  $[132] !== boundaryElement || $[133] !== t39 ? (t40 = /* @__PURE__ */ jsx(Flex, { direction: "column", flex: 1, height: "fill", ref: setBoundaryElement, children: /* @__PURE__ */ jsx(BoundaryElementProvider, { element: boundaryElement, children: t39 }) }), $[132] = boundaryElement, $[133] = t39, $[134] = t40) : t40 = $[134];
  let t41;
  $[135] !== t37 || $[136] !== t38 || $[137] !== t40 ? (t41 = /* @__PURE__ */ jsx(Panel, { id: "preview", htmlId: t36, minWidth: 325, defaultSize: t37, order: 3, hidden: t38, children: t40 }), $[135] = t37, $[136] = t38, $[137] = t40, $[138] = t41) : t41 = $[138];
  const t42 = isNarrow && resolvedTab !== "content";
  let t43;
  $[139] !== documentsOnPage || $[140] !== getCommentIntent || $[141] !== handleEditReference || $[142] !== handleFocusPath || $[143] !== handleStructureParams || $[144] !== isNarrow || $[145] !== mainDocumentState || $[146] !== params.id || $[147] !== params.type || $[148] !== searchParams || $[149] !== structureParams || $[150] !== t42 || $[151] !== visualOrderPublishedIds ? (t43 = /* @__PURE__ */ jsx(PresentationContent, { documentId: params.id, documentsOnPage, visualOrderPublishedIds, documentType: params.type, getCommentIntent, hidden: t42, mainDocumentState, onEditReference: handleEditReference, onFocusPath: handleFocusPath, onStructureParams: handleStructureParams, resizerHidden: isNarrow, searchParams, setDisplayedDocument, structureParams }), $[139] = documentsOnPage, $[140] = getCommentIntent, $[141] = handleEditReference, $[142] = handleFocusPath, $[143] = handleStructureParams, $[144] = isNarrow, $[145] = mainDocumentState, $[146] = params.id, $[147] = params.type, $[148] = searchParams, $[149] = structureParams, $[150] = t42, $[151] = visualOrderPublishedIds, $[152] = t43) : t43 = $[152];
  let t44;
  $[153] !== t35 || $[154] !== t41 || $[155] !== t43 ? (t44 = /* @__PURE__ */ jsx(Flex, { direction: "column", flex: 1, style: t33, children: /* @__PURE__ */ jsxs(Panels, { children: [
    t35,
    t41,
    t43
  ] }) }), $[153] = t35, $[154] = t41, $[155] = t43, $[156] = t44) : t44 = $[156];
  let t45;
  $[157] !== t32 || $[158] !== t44 ? (t45 = /* @__PURE__ */ jsxs(Container, { "data-testid": "presentation-root", direction: "column", height: "fill", children: [
    t32,
    t44
  ] }), $[157] = t32, $[158] = t44, $[159] = t45) : t45 = $[159];
  let t46;
  $[160] !== t45 || $[161] !== visualEditingComlink ? (t46 = /* @__PURE__ */ jsx(SharedStateProvider, { comlink: visualEditingComlink, children: t45 }), $[160] = t45, $[161] = visualEditingComlink, $[162] = t46) : t46 = $[162];
  let t47;
  $[163] !== params || $[164] !== t46 ? (t47 = /* @__PURE__ */ jsx(PresentationParamsProvider, { params, children: t46 }), $[163] = params, $[164] = t46, $[165] = t47) : t47 = $[165];
  let t48;
  $[166] !== navigate || $[167] !== t47 ? (t48 = /* @__PURE__ */ jsx(PresentationNavigateProvider, { navigate, children: t47 }), $[166] = navigate, $[167] = t47, $[168] = t48) : t48 = $[168];
  let t49;
  $[169] !== devMode || $[170] !== name || $[171] !== navigate || $[172] !== params || $[173] !== searchParams || $[174] !== structureParams || $[175] !== t48 ? (t49 = /* @__PURE__ */ jsx(PresentationProvider, { devMode, name, navigate, params, searchParams, structureParams, children: t48 }), $[169] = devMode, $[170] = name, $[171] = navigate, $[172] = params, $[173] = searchParams, $[174] = structureParams, $[175] = t48, $[176] = t49) : t49 = $[176];
  let t50;
  $[177] !== controller || $[178] !== displayedDocument || $[179] !== perspective || $[180] !== setDocumentsOnPage || $[181] !== setLoadersConnection || $[182] !== variant ? (t50 = controller && /* @__PURE__ */ jsx(LiveQueries, { controller, perspective, variant, liveDocument: displayedDocument, onDocumentsOnPage: setDocumentsOnPage, onLoadersConnection: setLoadersConnection }), $[177] = controller, $[178] = displayedDocument, $[179] = perspective, $[180] = setDocumentsOnPage, $[181] = setLoadersConnection, $[182] = variant, $[183] = t50) : t50 = $[183];
  let t51;
  $[184] !== loadersConnection || $[185] !== params.id || $[186] !== params.type || $[187] !== previewKitConnection || $[188] !== visualEditingComlink ? (t51 = visualEditingComlink && params.id && params.type && /* @__PURE__ */ jsx(PostMessageRefreshMutations, { comlink: visualEditingComlink, id: params.id, type: params.type, loadersConnection, previewKitConnection }), $[184] = loadersConnection, $[185] = params.id, $[186] = params.type, $[187] = previewKitConnection, $[188] = visualEditingComlink, $[189] = t51) : t51 = $[189];
  let t52;
  $[190] !== perspective || $[191] !== variant || $[192] !== visualEditingComlink ? (t52 = visualEditingComlink && /* @__PURE__ */ jsx(PostMessageSchema, { comlink: visualEditingComlink, perspective, variant }), $[190] = perspective, $[191] = variant, $[192] = visualEditingComlink, $[193] = t52) : t52 = $[193];
  let t53;
  $[194] !== documentsOnPage || $[195] !== perspective || $[196] !== visualEditingComlink ? (t53 = visualEditingComlink && documentsOnPage.length > 0 && /* @__PURE__ */ jsx(PostMessagePreviewSnapshots, { comlink: visualEditingComlink, perspective, refs: documentsOnPage }), $[194] = documentsOnPage, $[195] = perspective, $[196] = visualEditingComlink, $[197] = t53) : t53 = $[197];
  let t54;
  $[198] !== perspective || $[199] !== variant || $[200] !== visualEditingComlink ? (t54 = visualEditingComlink && /* @__PURE__ */ jsx(PostMessageDocuments, { comlink: visualEditingComlink, perspective, variant }), $[198] = perspective, $[199] = variant, $[200] = visualEditingComlink, $[201] = t54) : t54 = $[201];
  let t55;
  $[202] !== visualEditingComlink ? (t55 = visualEditingComlink && /* @__PURE__ */ jsx(PostMessageFeatures, { comlink: visualEditingComlink }), $[202] = visualEditingComlink, $[203] = t55) : t55 = $[203];
  let t56;
  $[204] !== perspective || $[205] !== variant || $[206] !== visualEditingComlink ? (t56 = visualEditingComlink && /* @__PURE__ */ jsx(PostMessagePerspective, { comlink: visualEditingComlink, perspective, variant, setHandlesPerspectiveChange, setHandlesVariantChange }), $[204] = perspective, $[205] = variant, $[206] = visualEditingComlink, $[207] = t56) : t56 = $[207];
  let t57;
  $[208] !== visualEditingComlink ? (t57 = visualEditingComlink && /* @__PURE__ */ jsx(PostMessageTelemetry, { comlink: visualEditingComlink }), $[208] = visualEditingComlink, $[209] = t57) : t57 = $[209];
  let t58;
  ...
  let t59;
  return $[219] !== t49 || $[220] !== t58 ? (t59 = /* @__PURE__ */ jsxs(Fragment, { children: [
    t49,
    t58
  ] }), $[219] = t49, $[220] = t58, $[221] = t59) : t59 = $[221], t59;
}
...
function usePreviewUrlActorRef(previewUrlOption, allowOption) {
  const $ = c(26), grantsStore = useGrantsStore();
  let t0;
  $[0] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t0 = {
    apiVersion: API_VERSION
  }, $[0] = t0) : t0 = $[0];
  ...
  const perspective = usePresentationPerspective(t2), variant = usePresentationVariant();
  let t3;
  if ($[4] !== allowOption || $[5] !== client || $[6] !== currentUserId || $[7] !== grantsStore || $[8] !== perspective || $[9] !== previewUrlOption || $[10] !== pushToast || $[11] !== studioBasePath || $[12] !== t || $[13] !== variant) {
    ...
    t3 = $[14];
  let t4;
  $[20] !== previewSearchParam ? (t4 = {
    input: {
      previewSearchParam
    }
  }, $[20] = previewSearchParam, $[21] = t4) : t4 = $[21];
