...
export class CreateDocumentCommand extends SanityCommand {
    ...
    async run() {
        ...
        if (!file && this.isUnattended()) {
            this.error('Document input is required in unattended mode. Pass it as the `<file>` argument.', {
        ...
        if (id && file) {
            this.error('Cannot use `--id` with the `<file>` argument. Remove `--id` or omit `<file>` and try again.', {
                exit: exitCodes.USAGE_ERROR
            });
        }
