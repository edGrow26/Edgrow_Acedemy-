...
let _sanity_color = require("@sanity/color"), react = require("react"), react_jsx_runtime = require("react/jsx-runtime");
/**
* @public
*/
const GroqLogo = /* @__PURE__ */ (0, react.forwardRef)(function(props, ref) {
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("svg", {
		...
		children: [
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", {
				d: "M32 0L0 32H32V0Z",
				fill: _sanity_color.hues.magenta[400].hex
			}),
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", {
				d: "M32 32H0L32 64V32Z",
				fill: _sanity_color.hues.green[300].hex
			}),
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", {
				d: "M64 32H32V64L64 32Z",
				fill: _sanity_color.hues.purple[300].hex
			}),
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", {
			...
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", {
				...
				fill: _sanity_color.hues.yellow[200].hex
			}),
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", {
				d: "M144 64L112 32V64H144Z",
				fill: _sanity_color.hues.blue[300].hex
			}),
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", {
				d: "M80 32V64H112L80 32Z",
				fill: _sanity_color.hues.orange[400].hex
			}),
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", {
...
}), GroqMonogram = /* @__PURE__ */ (0, react.forwardRef)(function(props, ref) {
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("svg", {
		...
		children: [
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)("rect", {
				...
				height: "128",
				rx: "8",
				fill: _sanity_color.hues.green[950].hex
			}),
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)("rect", {
				y: "32",
				width: "64",
				height: "64",
				fill: _sanity_color.hues.green[800].hex
			}),
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", {
...
}), NEW_SANITY_BLACK = "#0D0E12", SanityLogo = /* @__PURE__ */ (0, react.forwardRef)(function(props, ref) {
	let { dark, ...svgProps } = props, fill = dark ? _sanity_color.white.hex : NEW_SANITY_BLACK;
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("svg", {
	...
	light: {
		bg: _sanity_color.white.hex,
		fg: NEW_SANITY_BLACK
	},
	dark: {
		bg: NEW_SANITY_BLACK,
		fg: _sanity_color.white.hex
	},
	default: {
		bg: "#FF5500",
		fg: NEW_SANITY_BLACK
	}
}, SanityMonogram = /* @__PURE__ */ (0, react.forwardRef)(function(props, ref) {
	let { scheme = "default", color, ...restProps } = props, bg = (color == null ? void 0 : color.bg1) || SANITY_MONOGRAM_COLOR[scheme].bg, fg = (color == null ? void 0 : color.fg) || SANITY_MONOGRAM_COLOR[scheme].fg;
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("svg", {
...
exports.GroqLogo = GroqLogo, exports.GroqMonogram = GroqMonogram, exports.SanityLogo = SanityLogo, exports.SanityMonogram = SanityMonogram;
