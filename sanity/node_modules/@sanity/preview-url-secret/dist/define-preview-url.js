import { urlSearchParamPreviewSecret, urlSearchParamPreviewPerspective, urlSearchParamPreviewVariant, urlSearchParamPreviewPathname } from "./constants.js";
function definePreviewUrl(options) {
  ...
  return async (context) => {
    ...
    if (enablePreviewModeUrl) {
      ...
      return searchParams.set(urlSearchParamPreviewSecret, context.previewUrlSecret), searchParams.set(urlSearchParamPreviewPerspective, context.studioPreviewPerspective), context.studioPreviewVariant ? searchParams.set(urlSearchParamPreviewVariant, context.studioPreviewVariant) : searchParams.delete(urlSearchParamPreviewVariant), previewUrl.pathname !== enablePreviewModeRequestUrl.pathname && searchParams.set(
