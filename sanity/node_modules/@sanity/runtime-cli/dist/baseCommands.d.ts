...
import type { AuthParams, ScopeType, Stack, Warning } from './utils/types.js';
...
export declare abstract class ResolvedCommand<T extends typeof Command> extends RuntimeCommand<T> {
     ...
     */
    protected resolvedStackId?: string;
    /**
     ...
     */
    protected blueprintConfig?: LocatedBlueprintsConfig | null;
