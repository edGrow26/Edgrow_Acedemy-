    ...
    try {
        ...
        if (assetResources.length > 0) {
            ...
            for (const resource of assetResources) {
                const preDeployResult = await preDeploy(resource, { auth, blueprintFileDir, installer, log });
