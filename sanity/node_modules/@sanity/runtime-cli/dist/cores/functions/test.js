...
export async function functionTestCore(options) {
    ...
    try {
        ...
        const contextOptions = docFunction || mediaFunction
            ...
            : { clientOptions: {}, resources: resolvedResources, blueprintFileDir };
        ...
        const runNested = async (nestedName, nestedPayload, ctx, depth, callStack) => {
            ...
            const result = await runFunction(nestedResource, { payload: { data: nestedPayload }, event: 'nested' }, { ...ctx, resources: resolvedResources }, { depth, callStack, onNestedInvoke: runNested });
